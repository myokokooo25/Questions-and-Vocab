...
export const SpeakerIcon: React.FC<{ isLoading?: boolean } & React.SVGProps<SVGSVGElement>> = ({ isLoading, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${isLoading ? 'opacity-50' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} {...props}>
        {isLoading ? (
...
export const CheckCircleIcon: React.FC<{ solid?: boolean } & React.SVGProps<SVGSVGElement>> = ({ solid, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={solid ? "currentColor" : "none"} stroke="currentColor" strokeWidth={solid ? 0 : 1.5} {...props}>
        {solid ? (
