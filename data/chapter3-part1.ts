...
export const chapter3Part1Data: StudyCardData[] = [
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>鉄骨<rt>てっこつ</rt></ruby>は<ruby>顧客<rt>こきゃく</rt></ruby>に<ruby>対<rt>たい</rt></ruby>して<ruby>品質保証<rt>ひんしつほしょう</rt></ruby>されなければならない。", textMY: "(1) သံမဏိတည်ဆောက်ပုံကို ဝယ်ယူသူ (Customer) ထံ အရည်အသွေးအာမခံပေးရမည်။" },
      { id: 2, textJP: "(2) <ruby>鉄骨製品<rt>てっこつせいひん</rt></ruby>は<ruby>顧客<rt>こきゃく</rt></ruby>が<ruby>安心<rt>あんしん</rt></ruby>・<ruby>満足<rt>まんぞく</rt></ruby>できる<ruby>品質<rt>ひんしつ</rt></ruby>である<ruby>必要<rt>ひつよう</rt></ruby>があり、<ruby>生産者<rt>せいさんしゃ</rt></ruby>の<ruby>都合<rt>つごう</rt></ruby>だけでその<ruby>品質目標<rt>ひんしつもくひょう</rt></ruby>が<ruby>設定<rt>せってい</rt></ruby>されてはならない。", textMY: "(2) သံမဏိထုတ်ကုန်သည် ဝယ်ယူသူ စိတ်ချကျေနပ်မှုရှိသော အရည်အသွေးဖြစ်ရန်လိုအပ်ပြီး ထုတ်လုပ်သူ၏ အဆင်ပြေမှုတစ်ခုတည်းဖြင့် အရည်အသွေးပန်းတိုင်ကို မသတ်မှတ်သင့်ပါ။" },
      { id: 3, textJP: "(3) <ruby>品質保証<rt>ひんしつほしょう</rt></ruby>のための<ruby>最低<rt>さいてい</rt></ruby>の<ruby>要求<rt>ようきゅう</rt></ruby>として、<ruby>法律<rt>ほうりつ</rt></ruby>や<ruby>告示<rt>こくじ</rt></ruby>があり、<ruby>設計<rt>せっけい</rt></ruby>・<ruby>施工<rt>せこう</rt></ruby>における<ruby>品質保証<rt>ひんしつほしょう</rt></ruby>のための<ruby>目標値<rt>もくひょうち</rt></ruby>として、<ruby>基準<rt>きじゅん</rt></ruby>・<ruby>標準類<rt>ひょうじゅんるい</rt></ruby>などがある。", textMY: "(3) အရည်အသွေးအာမခံမှုအတွက် အနိမ့်ဆုံးလိုအပ်ချက်အဖြစ် ဥပဒေနှင့် ထုတ်ပြန်ချက်များရှိပြီး ဒီဇိုင်းနှင့် တည်ဆောက်မှုဆိုင်ရာ အရည်အသွေးအာမခံချက် ပန်းတိုင်တန်ဖိုးများအဖြစ် စံချိန်စံညွှန်းများနှင့် စံသတ်မှတ်ချက်များ ရှိသည်။" },
      { id: 4, textJP: "(4) <ruby>鉄骨製品<rt>てっこつせいひん</rt></ruby>の<ruby>品質保証<rt>ひんしつほしょう</rt></ruby>は、<ruby>設計図<rt>せっけいず</rt></ruby>に<ruby>不備<rt>ふび</rt></ruby>がなければおのずと<ruby>達成<rt>たっせい</rt></ruby>されるものであり、<ruby>設計業務<rt>せっけいぎょうむ</rt></ruby>の<ruby>成果物<rt>せいかぶつ</rt></ruby>として<ruby>捉<rt>とら</rt></ruby>えることができる。", textMY: "(4) သံမဏိထုတ်ကုန်၏ အရည်အသွေးအာမခံချက်သည် ဒီဇိုင်းပုံတွင် ချွတ်ယွင်းချက်မရှိပါက အလိုအလျောက် ရရှိပြီးမြောက်သောအရာဖြစ်ပြီး ဒီဇိုင်းလုပ်ငန်း၏ ရလဒ်တစ်ခုအဖြစ် သဘောထားနိုင်သည်။" },
      { id: 5, textJP: "(5) <ruby>設計品質<rt>せっけいひんしつ</rt></ruby>は、<ruby>設計者<rt>せっけいしゃ</rt></ruby>が<ruby>保証<rt>ほしょう</rt></ruby>しなければならない。", textMY: "(5) ဒီဇိုင်းအရည်အသွေးကို ဒီဇိုင်နာ (Architect/Engineer) က အာမခံပေးရမည်။" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 品質保証の考え方 (QA Concept)",
      reasonMY: "အရည်အသွေးအာမခံချက် (Quality Assurance) ဆိုသည်မှာ ဒီဇိုင်းပုံစံ (Design) အပြင် ထုတ်လုပ်မှု (Fabrication) နှင့် တည်ဆောက်မှု (Erection) လုပ်ငန်းစဉ်အားလုံး၏ စုပေါင်းရလဒ်ဖြစ်သည်။ ဒီဇိုင်းမှန်ရုံဖြင့် အလိုအလျောက် ရရှိလာသောအရာ မဟုတ်ပါ။",
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>品質<rt>ひんしつ</rt></ruby>マネジメントは、ISO 9000 シリーズにおいて、<ruby>経営者<rt>けいえいしゃ</rt></ruby>も<ruby>含<rt>ふく</rt></ruby>めた<ruby>企業組織全体<rt>きぎょうそしきぜんたい</rt></ruby>が、<ruby>顧客満足<rt>こきゃくまんぞく</rt></ruby>の<ruby>観点<rt>かんてん</rt></ruby>から品質を<ruby>継続的<rt>けいぞくてき</rt></ruby>に<ruby>改善<rt>かいぜん</rt></ruby>するための<ruby>管理手法<rt>かんりしゅほう</rt></ruby>である。", textMY: "(1) အရည်အသွေးစီမံခန့်ခွဲမှုသည် ISO 9000 စီးရီးအရ စီမံခန့်ခွဲသူများအပါအဝင် လုပ်ငန်းအဖွဲ့အစည်းတစ်ခုလုံးက ဝယ်ယူသူစိတ်ကျေနပ်မှုရှုထောင့်မှ အရည်အသွေးကို စဉ်ဆက်မပြတ် တိုးတက်စေရန် စီမံခန့်ခွဲသည့် နည်းစနစ်ဖြစ်သည်။" },
      { id: 2, textJP: "(2) <ruby>品質<rt>ひんしつ</rt></ruby>マネジメントは、プロセス（<ruby>工程<rt>こうてい</rt></ruby>）を<ruby>重視<rt>じゅうし</rt></ruby>する<ruby>管理技術<rt>かんりぎじゅつ</rt></ruby>である。", textMY: "(2) အရည်အသွေးစီမံခန့်ခွဲမှုသည် လုပ်ငန်းစဉ် (Process) ကို အဓိကထားသော စီမံခန့်ခွဲမှု နည်းပညာဖြစ်သည်။" },
      { id: 3, textJP: "(3) <ruby>品質<rt>ひんしつ</rt></ruby>マネジメントにおいて、<ruby>不具合<rt>ふぐあい</rt></ruby>の<ruby>防止<rt>ぼうし</rt></ruby>と<ruby>製品品質<rt>せいひんひんしつ</rt></ruby>を<ruby>改善<rt>かいぜん</rt></ruby>するためには、<ruby>試験<rt>しけん</rt></ruby>・<ruby>検査<rt>けんさ</rt></ruby>を<ruby>厳重<rt>げんじゅう</rt></ruby>に<ruby>実施<rt>じっし</rt></ruby>し、<ruby>不適合<rt>ふてきごう</rt></ruby>が<ruby>発見<rt>はっけん</rt></ruby>されたらその<ruby>都度手直<rt>つどてなお</rt></ruby>しすることが<ruby>最<rt>もっと</rt></ruby>も<ruby>重要<rt>じゅうよう</rt></ruby>となる。", textMY: "(3) အရည်အသွေးစီမံခန့်ခွဲမှုတွင် ချို့ယွင်းချက်ကာကွယ်ရန်နှင့် ထုတ်ကုန်အရည်အသွေး တိုးတက်စေရန် စမ်းသပ်စစ်ဆေးမှုများကို တင်းကြပ်စွာ ပြုလုပ်ပြီး မကိုက်ညီမှုတွေ့ရှိပါက အကြိမ်တိုင်း ပြန်လည်ပြင်ဆင်ခြင်းသည် အရေးအကြီးဆုံးဖြစ်သည်။" },
      { id: 4, textJP: "(4) <ruby>不具合<rt>ふぐあい</rt></ruby>を<ruby>防止<rt>ぼうし</rt></ruby>し<ruby>製品品質<rt>せいひんひんしつ</rt></ruby>を<ruby>継続的<rt>けいぞくてき</rt></ruby>に<ruby>改善<rt>かいぜん</rt></ruby>・<ruby>向上<rt>こうじょう</rt></ruby>するためには、PDCA サイクルを<ruby>全員<rt>ぜんいん</rt></ruby>が<ruby>組織的<rt>そしきてき</rt></ruby>に<ruby>繰<rt>く</rt></ruby>り<ruby>返<rt>かえ</rt></ruby>す<ruby>必要<rt>ひつよう</rt></ruby>がある。", textMY: "(4) ချို့ယွင်းချက်ကို ကာကွယ်ပြီး ထုတ်ကုန်အရည်အသွေးကို စဉ်ဆက်မပြတ် တိုးတက်ကောင်းမွန်စေရန် PDCA စက်ဝန်းကို လူတိုင်း အဖွဲ့အစည်းလိုက် ပြန်ခါပြန်ခါ ကျင့်သုံးရန် လိုအပ်သည်။" },
      { id: 5, textJP: "(5) PDCA サイクルは、Act を<ruby>次<rt>つぎ</rt></ruby>のサイクルにつなげ、<ruby>螺旋状<rt>らせんじょう</rt></ruby>に<ruby>業務改善<rt>ぎょうむかいぜん</rt></ruby>（スパイラルアップ）を<ruby>図<rt>はか</rt></ruby>るものである。", textMY: "(5) PDCA စက်ဝန်းသည် Act ကို နောက်စက်ဝန်းသို့ ဆက်လက်ချိတ်ဆက်ပြီး ခရုပတ်သဖွယ် လုပ်ငန်းတိုးတက်မှု (Spiral-up) ကို ရည်မှန်းသည်။" }
    ],
    correctOptionId: 3,
    explanation: {
      ...
      memoryTipMY: "QM = မမှားအောင် အရင်လုပ် (Prevention), မှားမှ ပြင်တာ (Correction) မဟုတ်။"
    }
  },
  {
    id: "3-3",
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>鉄骨製作業者<rt>てっこつせいさくぎょうしゃ</rt></ruby>は<ruby>様々<rt>さまざま</rt></ruby>な<ruby>機能<rt>きのう</rt></ruby>を<ruby>持<rt>も</rt></ruby>ったシステムを<ruby>確立<rt>かくりつ</rt></ruby>し、システム<ruby>図<rt>ず</rt></ruby>などで<ruby>明示<rt>めいじ</rt></ruby>するとされている。", textMY: "(1) သံမဏိထုတ်လုပ်သူသည် လုပ်ဆောင်ချက်အမျိုးမျိုးပါဝင်သော စနစ်ကို တည်ဆောက်ပြီး စနစ်ဇယား (System Chart) စသည်တို့ဖြင့် ရှင်းလင်းစွာ ဖော်ပြရမည်။" },
      { id: 2, textJP: "(2) 「<ruby>品質保証<rt>ひんしつほしょう</rt></ruby>に<ruby>必要<rt>ひつよう</rt></ruby>な<ruby>記録<rt>きろく</rt></ruby>を<ruby>保管<rt>ほかん</rt></ruby>・<ruby>管理<rt>かんり</rt></ruby>する<ruby>機能<rt>きのう</rt></ruby>」は、システムが<ruby>持<rt>も</rt></ruby>つべき<ruby>機能<rt>きのう</rt></ruby>である。", textMY: "(2) 「အရည်အသွေးအာမခံချက်အတွက် လိုအပ်သော မှတ်တမ်းများကို သိမ်းဆည်းစီမံသည့် လုပ်ဆောင်ချက်」 သည် စနစ်တွင် ပါဝင်ရမည့် လုပ်ဆောင်ချက်ဖြစ်သည်။" },
      { id: 3, textJP: "(3) 「<ruby>施工品質<rt>せこうひんしつ</rt></ruby>を<ruby>検査<rt>けんさ</rt></ruby>・<ruby>検証<rt>けんしょう</rt></ruby>する<ruby>機能<rt>きのう</rt></ruby>」は、システムが<ruby>持<rt>も</rt></ruby>つべき<ruby>機能<rt>きのう</rt></ruby>である。", textMY: "(3) 「တည်ဆောက်မှု အရည်အသွေးကို စစ်ဆေးအတည်ပြုသည့် လုပ်ဆောင်ချက်」 သည် စနစ်တွင် ပါဝင်ရမည့် လုပ်ဆောင်ချက်ဖြစ်သည်။" },
      { id: 4, textJP: "(4) 「<ruby>標準化<rt>ひょうじゅんか</rt></ruby>を<ruby>進<rt>すす</rt></ruby>める<ruby>機能<rt>きのう</rt></ruby>」は、システムが<ruby>持<rt>も</rt></ruby>つべき<ruby>機能<rt>きのう</rt></ruby>として<ruby>定<rt>さだ</rt></ruby>められている。", textMY: "(4) 「စံသတ်မှတ်ခြင်း (Standardization) ကို ဆောင်ရွက်သည့် လုပ်ဆောင်ချက်」 သည် စနစ်တွင် ပါဝင်ရမည့် လုပ်ဆောင်ချက်အဖြစ် သတ်မှတ်ထားသည်။" },
      { id: 5, textJP: "(5) <ruby>鉄骨工事<rt>てっこつこうじ</rt></ruby>の品質マネジメントを<ruby>有効<rt>ゆうこう</rt></ruby>とするためには、<ruby>設計者<rt>せっけいしゃ</rt></ruby>と<ruby>施工者<rt>せこうしゃ</rt></ruby>が<ruby>連携<rt>れんけい</rt></ruby>を<ruby>取<rt>と</rt></ruby>り、<ruby>製作業者<rt>せいさくぎょうしゃ</rt></ruby>はその<ruby>指示<rt>しじ</rt></ruby>どおりの<ruby>製作<rt>せいさく</rt></ruby>に<ruby>集中<rt>しゅうちゅう</rt></ruby>することが<ruby>重要<rt>じゅうよう</rt></ruby>である。", textMY: "(5) သံမဏိလုပ်ငန်း၏ အရည်အသွေးစီမံခန့်ခွဲမှု ထိရောက်စေရန် ဒီဇိုင်နာနှင့် တည်ဆောက်သူတို့ ပူးပေါင်းဆောင်ရွက်ပြီး ထုတ်လုပ်သူသည် ထိုညွှန်ကြားချက်အတိုင်း ထုတ်လုပ်ခြင်းတစ်ခုတည်းကိုသာ အာရုံစိုက်ရန် အရေးကြီးသည်။" }
    ],
    correctOptionId: 5,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>受注<rt>じゅちゅう</rt></ruby>から<ruby>納品<rt>のうひん</rt></ruby>までの<ruby>業務<rt>ぎょうむ</rt></ruby>の流れに従い、<ruby>保証項目<rt>ほしょうこうもく</rt></ruby>や<ruby>責任者<rt>せきにんしゃ</rt></ruby>を<ruby>明確<rt>めいかく</rt></ruby>にしたものを「<ruby>品質保証体系図<rt>ひんしつほしょうたいけいず</rt></ruby>」という。", textMY: "(1) အမှာစာလက်ခံခြင်းမှ ကုန်ပစ္စည်းပေးပို့ခြင်းအထိ လုပ်ငန်းအဆင့်ဆင့်အရ အာမခံချက်အချက်များနှင့် တာဝန်ရှိသူများကို ရှင်းလင်းစွာ ဖော်ပြထားသော ဇယားကို 「အရည်အသွေးအာမခံချက်စနစ်ဇယား (QA System Chart)」 ဟုခေါ်သည်။" },
      { id: 2, textJP: "(2) <ruby>材料<rt>ざいりょう</rt></ruby>・<ruby>機械<rt>きかい</rt></ruby>・<ruby>人<rt>ひと</rt></ruby>・<ruby>作業方法<rt>さぎょうほうほう</rt></ruby>などの 4M を、<ruby>工程<rt>こうてい</rt></ruby>の流れに沿って<ruby>示<rt>しめ</rt></ruby>したものを PDCA サイクルという。", textMY: "(2) ပစ္စည်း၊ စက်ယန္တရား၊ လူ၊ လုပ်နည်းစနစ် စသည့် 4M ကို လုပ်ငန်းစဉ်အတိုင်း ဖော်ပြထားသည်ကို PDCA စက်ဝန်းဟု ခေါ်သည်။" },
      { id: 3, textJP: "(3) <ruby>品質管理<rt>ひんしつかんり</rt></ruby>に<ruby>関<rt>かん</rt></ruby>する<ruby>機能<rt>きのう</rt></ruby>を<ruby>明確<rt>めいかく</rt></ruby>にし、<ruby>効率的<rt>こうりつてき</rt></ruby>に<ruby>実施<rt>じっし</rt></ruby>するための<ruby>組織<rt>そしき</rt></ruby>を「<ruby>品質管理組織<rt>ひんしつかんりそしき</rt></ruby>」という。", textMY: "(3) အရည်အသွေးထိန်းချုပ်မှုဆိုင်ရာ လုပ်ဆောင်ချက်များကို ရှင်းလင်းစေပြီး ထိရောက်စွာ အကောင်အထည်ဖော်ရန် ဖွဲ့စည်းထားသော အဖွဲ့အစည်းကို 「အရည်အသွေးထိန်းချုပ်မှု အဖွဲ့အစည်း」 ဟုခေါ်သည်။" },
      { id: 4, textJP: "(4) <ruby>作業者<rt>さぎょうしゃ</rt></ruby>が<ruby>誤<rt>あやま</rt></ruby>った<ruby>操作<rt>そうさ</rt></ruby>をしても<ruby>危険<rt>きけん</rt></ruby>にさらされないよう、あらかじめ<ruby>安全対策<rt>あんぜんたいさく</rt></ruby>を<ruby>施<rt>ほどこ</rt></ruby>しておくことを「フールプルーフ」という。", textMY: "(4) လုပ်သားများ မှားယွင်းစွာ ကိုင်တွယ်သော်လည်း အန္တရာယ်မဖြစ်စေရန် ကြိုတင်ကာကွယ်ထားသည့် ဘေးကင်းရေး အစီအမံကို 「Fool-proof」 ဟုခေါ်သည်။" },
      { id: 5, textJP: "(5) <ruby>収集<rt>しゅうしゅう</rt></ruby>したデータの<ruby>傾向<rt>けいこう</rt></ruby>や<ruby>性質<rt>せいしつ</rt></ruby>を<ruby>数値的<rt>すうちてき</rt></ruby>に<ruby>把握<rt>はあく</rt></ruby>する<ruby>統計的手法<rt>とうけいてきしゅほう</rt></ruby>を<ruby>用<rt>もち</rt></ruby>いた<ruby>管理<rt>かんり</rt></ruby>を「<ruby>統計的品質管理<rt>とうけいてきひんしつかんり</rt></ruby>」という。", textMY: "(5) စုဆောင်းရရှိသော ဒေတာများ၏ အလားအလာနှင့် သဘာဝကို ကိန်းဂဏန်းဖြင့် နားလည်စေရန် စာရင်းအင်းနည်းလမ်းဖြင့် စီမံခန့်ခွဲခြင်းကို 「စာရင်းအင်းနည်းဖြင့် အရည်အသွေးထိန်းချုပ်ခြင်း (SQC)」 ဟုခေါ်သည်။" }
    ],
    correctOptionId: 2,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - QC工程表 vs PDCA",
      reasonMY: "လုပ်ငန်းစဉ်အဆင့်ဆင့်တွင် 4M (လူ၊ ပစ္စည်း၊ စက်၊ နည်းလမ်း) တို့ကို ဘယ်လိုစီမံမလဲဆိုတာကို ဖော်ပြသည့်ဇယားမှာ 'QC Flow Chart' (QC工程表) ဖြစ်သည်။ PDCA (Plan-Do-Check-Act) မှာ စီမံခန့်ခွဲမှု လည်ပတ်ပုံစနစ်သာ ဖြစ်သည်။",
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>近代的な品質管理<rt>きんだいてきなひんしつかんり</rt></ruby>は、<ruby>統計的手法<rt>とうけいてきしゅほう</rt></ruby>を<ruby>採用<rt>さいよう</rt></ruby>している。", textMY: "(1) ခေတ်မီ အရည်အသွေးထိန်းချုပ်မှုသည် စာရင်းအင်းနည်းလမ်းများကို အသုံးပြုထားသည်။" },
      { id: 2, textJP: "(2) <ruby>統計的手法<rt>とうけいてきしゅほう</rt></ruby>とは、<ruby>収集<rt>しゅうしゅう</rt></ruby>したデータの<ruby>傾向<rt>けいこう</rt></ruby>を<ruby>把握<rt>はあく</rt></ruby>するための<ruby>手法<rt>しゅほう</rt></ruby>であり、「QC 7 つ<ruby>道具<rt>どうぐ</rt></ruby>」などがよく<ruby>用いられる<rt>もちいられる</rt></ruby>。", textMY: "(2) စာရင်းအင်းနည်းလမ်းဆိုသည်မှာ စုဆောင်းရရှိသော ဒေတာများ၏ အလားအလာကို နားလည်ရန် နည်းလမ်းဖြစ်ပြီး 「QC ကိရိယာ ၇ မျိုး」 စသည်တို့ကို အများဆုံး အသုံးပြုသည်။" },
      { id: 3, textJP: "(3) <ruby>抜取検査<rt>ぬきとりけんさ</rt></ruby>は、<ruby>一部<rt>いちぶ</rt></ruby>のデータをもとに<ruby>集団全体<rt>しゅうだんぜんたい</rt></ruby>の<ruby>姿<rt>すがた</rt></ruby>を<ruby>推定<rt>すいてい</rt></ruby>するものである。", textMY: "(3) နမူနာစစ်ဆေးခြင်း (Sampling) သည် ဒေတာတစ်စိတ်တစ်ပိုင်းပေါ် အခြေခံ၍ အုပ်စုတစ်ခုလုံး၏ အခြေအနေကို ခန့်မှန်းခြင်းဖြစ်သည်။" },
      { id: 4, textJP: "(4) <ruby>抜取検査<rt>ぬきとりけんさ</rt></ruby>は、<ruby>個々<rt>ここ</rt></ruby>の<ruby>製品<rt>せいひん</rt></ruby>の<ruby>測定値<rt>そくていち</rt></ruby>がばらばらで、<ruby>製品全体<rt>せいひんぜんたい</rt></ruby>のバラツキを<ruby>特定<rt>とくてい</rt></ruby>の<ruby>数値<rt>すうち</rt></ruby>で<ruby>表<rt>あらわ</rt></ruby>すことができない<ruby>場合<rt>ばあい</rt></ruby>でも、<ruby>統計的手法<rt>とうけいてきしゅほう</rt></ruby>を<ruby>用いる<rt>もちいる</rt></ruby>ことで<ruby>適用<rt>てきよう</rt></ruby>することができる。", textMY: "(4) နမူနာစစ်ဆေးခြင်းသည် ထုတ်ကုန်တစ်ခုချင်းစီ၏ တိုင်းတာချက်များ ကွဲလွဲနေပြီး ထုတ်ကုန်တစ်ခုလုံး၏ ကွဲလွဲမှုကို သီးခြားကိန်းဂဏန်းဖြင့် ဖော်ပြ၍မရသည့်အခါတွင်လည်း စာရင်းအင်းနည်းလမ်းကို အသုံးပြုခြင်းဖြင့် အသုံးချနိုင်သည်။" },
      { id: 5, textJP: "(5) <ruby>計量値データ<rt>けいりょうちデータ</rt></ruby>の多くは<ruby>正規分布<rt>せいきぶんぷ</rt></ruby>となり、<ruby>計数値データ<rt>けいすうちデータ</rt></ruby>は<ruby>二項分布<rt>にこうぶんぷ</rt></ruby>になることが<ruby>知<rt>し</rt></ruby>られている。", textMY: "(5) တိုင်းတာရသော ဒေတာ (Measurable data) များသည် ပုံမှန်ပြန့်နှံ့မှု (Normal distribution) ဖြစ်လေ့ရှိပြီး ရေတွက်ရသော ဒေတာ (Countable data) များသည် Binomial distribution ဖြစ်လေ့ရှိကြောင်း သိထားကြသည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>品質管理活動<rt>ひんしつかんりかつどう</rt></ruby>において、<ruby>現状<rt>げんじょう</rt></ruby>を<ruby>正確<rt>せいかく</rt></ruby>に<ruby>把握<rt>はあく</rt></ruby>するとともに、<ruby>客観的<rt>きゃっかんてき</rt></ruby>なデータとして<ruby>表<rt>あらわ</rt></ruby>す<ruby>必要<rt>ひつよう</rt></ruby>がある。", textMY: "(1) အရည်အသွေးထိန်းချုပ်မှု လှုပ်ရှားမှုတွင် လက်ရှိအခြေအနေကို တိကျစွာ နားလည်ရန်နှင့် ရည်မှန်းချက်ရှိသော (Objective) ဒေတာအဖြစ် ဖော်ပြရန် လိုအပ်သည်။" },
      { id: 2, textJP: "(2) <ruby>母集団<rt>ぼしゅうだん</rt></ruby>の<ruby>姿<rt>すがた</rt></ruby>を<ruby>正確<rt>せいかく</rt></ruby>に<ruby>把握<rt>はあく</rt></ruby>するためには、<ruby>作為的<rt>さいてき</rt></ruby>にデータを<ruby>採取<rt>さいしゅ</rt></ruby>してはならず、<ruby>無作為<rt>むさくい</rt></ruby>にデータを<ruby>採取<rt>さいしゅ</rt></ruby>（ランダムサンプリング）する<ruby>必要<rt>ひつよう</rt></ruby>がある。", textMY: "(2) အုပ်စုတစ်ခုလုံး (Population) ၏ ပကတိအခြေအနေကို တိကျစွာ သိရှိနိုင်ရန် ဒေတာများကို ရည်ရွယ်ချက်ဖြင့် မကောက်ယူဘဲ ကျပန်းနမူနာကောက်ယူခြင်း (Random sampling) ဖြင့် ကောက်ယူရန် လိုအပ်သည်။" },
      { id: 3, textJP: "(3) <ruby>不具合<rt>ふぐあい</rt></ruby>が<ruby>連続<rt>れんぞく</rt></ruby>して<ruby>生産<rt>せいさん</rt></ruby>されるなどのことが<ruby>生<rt>しょう</rt></ruby>じないように、データは<ruby>迅速<rt>じんそく</rt></ruby>かつ<ruby>正確<rt>せいかく</rt></ruby>に<ruby>処理<rt>しょり</rt></ruby>する。", textMY: "(3) ချို့ယွင်းချက်များ ဆက်တိုက်ထုတ်လုပ်မိခြင်း မဖြစ်စေရန် ဒေတာများကို လျင်မြန်တိကျစွာ စီမံဆောင်ရွက်ရမည်။" },
      { id: 4, textJP: "(4) データには<ruby>計量値<rt>けいりょうち</rt></ruby>と<ruby>計数値<rt>けいすうち</rt></ruby>がある。<ruby>両者<rt>りょうしゃ</rt></ruby>は<ruby>数値<rt>すうち</rt></ruby>の<ruby>性質<rt>せいしつ</rt></ruby>は<ruby>同<rt>おな</rt></ruby>じであるが、<ruby>採取<rt>さいしゅ</rt></ruby>や<ruby>処理<rt>しょり</rt></ruby>の<ruby>方法<rt>ほうほう</rt></ruby>が<ruby>異<rt>こと</rt></ruby>なる。", textMY: "(4) ဒေတာတွင် တိုင်းတာရသောတန်ဖိုး (Measurable) နှင့် ရေတွက်ရသောတန်ဖိုး (Countable) ရှိသည်။ နှစ်မျိုးစလုံးသည် ကိန်းဂဏန်းသဘာဝချင်း တူညီသော်လည်း ကောက်ယူမှုနှင့် စီမံဆောင်ရွက်မှု နည်းလမ်းများ ကွဲပြားသည်။" },
      { id: 5, textJP: "(5) <ruby>測定誤差<rt>そくていごさ</rt></ruby>など、データには<ruby>誤差<rt>ごさ</rt></ruby>が<ruby>生<rt>しょう</rt></ruby>じる<ruby>要因<rt>よういん</rt></ruby>が<ruby>存在<rt>そんざい</rt></ruby>することを<ruby>認識<rt>にんしき</rt></ruby>しておく<ruby>必要<rt>ひつよう</rt></ruby>がある。", textMY: "(5) တိုင်းတာမှုအမှားအယွင်းကဲ့သို့သော ဒေတာတွင် အမှားအယွင်းဖြစ်စေသည့် အကြောင်းရင်းများ ရှိနေကြောင်း သဘောပေါက်ထားရန် လိုအပ်သည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) A には、<ruby>強<rt>つよ</rt></ruby>い<ruby>正<rt>せい</rt></ruby>の<ruby>相関<rt>そうかん</rt></ruby>がある。", textMY: "(1) A တွင် ခိုင်မာသော အပေါင်းဆက်နွယ်မှု (Strong Positive Correlation) ရှိသည်။" },
      { id: 2, textJP: "(2) B には、<ruby>強<rt>つよ</rt></ruby>い<ruby>負<rt>ふ</rt></ruby>の<ruby>相関<rt>そうかん</rt></ruby>がある。", textMY: "(2) B တွင် ခိုင်မာသော အနှုတ်ဆက်နွယ်မှု (Strong Negative Correlation) ရှိသည်။" },
      { id: 3, textJP: "(3) C には、<ruby>弱<rt>よわ</rt></ruby>い<ruby>正<rt>せい</rt></ruby>の<ruby>相関<rt>そうかん</rt></ruby>がある。", textMY: "(3) C တွင် အားနည်းသော အပေါင်းဆက်နွယ်မှု (Weak Positive Correlation) ရှိသည်။" },
      { id: 4, textJP: "(4) D には、<ruby>弱<rt>よわ</rt></ruby>い<ruby>負<rt>ふ</rt></ruby>の<ruby>相関<rt>そうかん</rt></ruby>がある。", textMY: "(4) D တွင် အားနည်းသော အနှုတ်ဆက်နွယ်မှု (Weak Negative Correlation) ရှိသည်။" },
      { id: 5, textJP: "(5) E には、<ruby>相関<rt>そうかん</rt></ruby>がない。", textMY: "(5) E တွင် ဆက်နွယ်မှု မရှိပါ။" }
    ],
    correctOptionId: 5,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) ロットの<ruby>不良率<rt>ふりょうりつ</rt></ruby>を<ruby>横軸<rt>よこじく</rt></ruby>に、ロットが<ruby>合格<rt>ごうかく</rt></ruby>する<ruby>確率<rt>かくりつ</rt></ruby>を<ruby>縦軸<rt>たてじく</rt></ruby>にとり、この<ruby>関係<rt>かんけい</rt></ruby>を<ruby>表<rt>あらわ</rt></ruby>したものを OC <ruby>曲線<rt>きょくせん</rt></ruby>という。", textMY: "(1) Lot ၏ ချို့ယွင်းမှုနှုန်းကို အလျားလိုက်ဝင်ရိုး (X) နှင့် Lot အောင်မြင်နိုင်ခြေ အချိုးကို ဒေါင်လိုက်ဝင်ရိုး (Y) တွင် ထားရှိဖော်ပြသော မျဉ်းကွေးကို OC Curve ဟုခေါ်သည်။" },
      { id: 2, textJP: "(2) OC <ruby>曲線<rt>きょくせん</rt></ruby>は、<ruby>抜取検査方式<rt>ぬきとりけんさほうしき</rt></ruby>が<ruby>決<rt>き</rt></ruby>まれば、それに対して<ruby>固有<rt>こゆう</rt></ruby>のものに<ruby>決<rt>き</rt></ruby>まる。", textMY: "(2) OC Curve သည် နမူနာစစ်ဆေးမှု နည်းလမ်းသတ်မှတ်လိုက်ပါက ၎င်းအတွက် သီးသန့်တန်ဖိုးအဖြစ် သတ်မှတ်ပြီး ဖြစ်သည်။" },
      { id: 3, textJP: "(3) <ruby>抜取検査<rt>ぬきとりけんさ</rt></ruby>では、<ruby>合否判定基準<rt>ごうひはんていきじゅん</rt></ruby>を<ruby>厳<rt>きび</rt></ruby>しく<ruby>設定<rt>せってい</rt></ruby>すれば、<ruby>不良率<rt>ふりょうりつ</rt></ruby>が<ruby>低<rt>ひく</rt></ruby>い“<ruby>良<rt>よ</rt></ruby>いロット”が<ruby>不合格<rt>ふごうかく</rt></ruby>となることや、<ruby>不良率<rt>ふりょうりつ</rt></ruby>が<ruby>高<rt>たか</rt></ruby>い“<ruby>悪<rt>わる</rt></ruby>いロット”が<ruby>合格<rt>ごうかく</rt></ruby>となることは<ruby>回避<rt>かいひ</rt></ruby>される。", textMY: "(3) နမူနာစစ်ဆေးခြင်းတွင် အောင်/ရှုံး ဆုံးဖြတ်ချက်စံနှုန်းကို တင်းကြပ်စွာ သတ်မှတ်ပါက ချို့ယွင်းမှုနှုန်းနည်းသော \"ကောင်းသော Lot\" ကျရှုံးခြင်း သို့မဟုတ် ချို့ယွင်းမှုနှုန်းများသော \"ဆိုးသော Lot\" အောင်မြင်ခြင်းတို့ကို လုံးဝရှောင်ရှားနိုင်သည်။" },
      { id: 4, textJP: "(4) OC <ruby>曲線<rt>きょくせん</rt></ruby>を<ruby>観察<rt>かんさつ</rt></ruby>することによって、ある<ruby>不良率<rt>ふりょうりつ</rt></ruby>のロットがどれくらいの<ruby>割合<rt>わりあい</rt></ruby>で<ruby>合格<rt>ごうかく</rt></ruby>になるかを知ることができる。", textMY: "(4) OC Curve ကို ကြည့်ရှုလေ့လာခြင်းဖြင့် သတ်မှတ်ချို့ယွင်းမှုနှုန်းရှိသော Lot တစ်ခုသည် မည်မျှအချိုးဖြင့် အောင်မြင်မည်ကို သိရှိနိုင်သည်။" },
      { id: 5, textJP: "(5) <ruby>抜取検査<rt>ぬきとりけんさ</rt></ruby>において、“<ruby>良<rt>よ</rt></ruby>いロット”を“<ruby>悪<rt>わる</rt></ruby>いロット”とみなす<ruby>危険性<rt>きけんせい</rt></ruby>を<ruby>生産者危険<rt>せいさんしゃきけん</rt></ruby>といい、“<ruby>悪<rt>わる</rt></ruby>いロット”を“<ruby>良<rt>よ</rt></ruby>いロット”とみなす<ruby>危険性<rt>きけんせい</rt></ruby>を<ruby>消費者危険<rt>しょうひしゃきけん</rt></ruby>という。", textMY: "(5) နမူနာစစ်ဆေးခြင်းတွင် \"ကောင်းသော Lot\" ကို \"ဆိုးသော Lot\" ဟု သတ်မှတ်မိနိုင်သော အန္တရာယ်ကို ထုတ်လုပ်သူအန္တရာယ် (Producer's Risk) ဟုခေါ်ပြီး \"ဆိုးသော Lot\" ကို \"ကောင်းသော Lot\" ဟု သတ်မှတ်မိနိုင်သော အန္တရာယ်ကို စားသုံးသူအန္တရာယ် (Consumer's Risk) ဟုခေါ်သည်။" }
    ],
    correctOptionId: 3,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 抜取検査の限界 (Sampling Limitation)",
  ...
  },
  {
    ...
    explanation: {
      ...
      memoryTipMY: "စက်ရုံကထွက်ပြီးသား ပစ္စည်းကို စစ်ရင် '製品分析' (Check analysis) ပဲ လုပ်လို့ရတယ်။"
    }
  },
  {
    id: "3-11",
  ...
  },
  {
    ...
    questionMY: "JASS 6 အရ ကြားဖြတ်စစ်ဆေးမှုနှင့် လက်ခံစစ်ဆေးမှုဆိုင်ရာ မသင့်လျော်သည့်အချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>製品<rt>せいひん</rt></ruby>の<ruby>寸法精度<rt>すんぽうせいど</rt></ruby>の<ruby>受入検査方法<rt>うけいれけんさほうほう</rt></ruby>には<ruby>書類検査<rt>しょるいけんさ</rt></ruby>と<ruby>対物検査<rt>たいぶつけんさ</rt></ruby>があり、<ruby>対物検査<rt>たいぶつけんさ</rt></ruby>を<ruby>行<rt>おこな</rt></ruby>う<ruby>場合<rt>ばあい</rt></ruby>は<ruby>特記<rt>とっき</rt></ruby>による。", textMY: "(1) ထုတ်ကုန်၏ အတိုင်းအတာ တိကျမှု လက်ခံစစ်ဆေးခြင်း နည်းလမ်းတွင် စာရွက်စာတမ်း စစ်ဆေးခြင်းနှင့် ပစ္စည်းစစ်ဆေးခြင်းတို့ ပါဝင်ပြီး ပစ္စည်းစစ်ဆေးခြင်း ပြုလုပ်ပါက သီးသန့်သတ်မှတ်ချက် (Spec) အတိုင်းဖြစ်သည်။" },
      { id: 2, textJP: "(2) <ruby>書類検査<rt>しょるいけんさ</rt></ruby>の<ruby>検査方法<rt>けんさほうほう</rt></ruby>は、<ruby>特記<rt>とっき</rt></ruby>のない<ruby>場合<rt>ばあい</rt></ruby>、<ruby>社内検査成績表<rt>しゃないけんさせいせきひょう</rt></ruby>に<ruby>対<rt>たい</rt></ruby>する<ruby>検査<rt>けんさ</rt></ruby>とし、「JASS 6」<ruby>付則<rt>ふそく</rt></ruby> 7 「<ruby>寸法精度受入検査基準<rt>すんぽうせいどうけいれけんさきじゅん</rt></ruby>」に<ruby>示<rt>しめ</rt></ruby>す「<ruby>書類検査<rt>しょるいけんさ</rt></ruby>」による。", textMY: "(2) စာရွက်စာတမ်း စစ်ဆေးခြင်းနည်းလမ်းသည် သီးသန့်သတ်မှတ်ချက်မရှိပါက စက်ရုံတွင်း စစ်ဆေးမှုရလဒ်ဇယားကို စစ်ဆေးခြင်းဖြစ်ပြီး JASS 6 နောက်ဆက်တွဲ ၇ ပါ 「စာရွက်စာတမ်း စစ်ဆေးခြင်း」 အတိုင်း ဖြစ်သည်။" },
      { id: 3, textJP: "(3) <ruby>対物検査<rt>たいぶつけんさ</rt></ruby>を<ruby>行<rt>おこな</rt></ruby>う<ruby>場合<rt>ばあい</rt></ruby>は、「JASS 6」<ruby>付則<rt>ふそく</rt></ruby> 7 「<ruby>寸法精度受入検査基準<rt>すんぽうせいどうけいれけんさきじゅん</rt></ruby>」に<ruby>示<rt>しめ</rt></ruby>す「<ruby>対物検査 1<rt>たいぶつけんさいち</rt></ruby>」、「<ruby>対物検査 2<rt>たいぶつけんさに</rt></ruby>」あるいはその<ruby>他<rt>た</rt></ruby>の<ruby>方法<rt>ほうほう</rt></ruby>によるものとし、その<ruby>種類<rt>しゅるい</rt></ruby>は<ruby>特記<rt>とっき</rt></ruby>による。", textMY: "(3) ပစ္စည်းစစ်ဆေးမှု ပြုလုပ်ပါက JASS 6 နောက်ဆက်တွဲ ၇ ပါ 「ပစ္စည်းစစ်ဆေးမှု ၁」၊ 「ပစ္စည်းစစ်ဆေးမှု ၂」 သို့မဟုတ် အခြားနည်းလမ်းများဖြင့် ဆောင်ရွက်ပြီး ၎င်းအမျိုးအစားကို Spec တွင် သတ်မှတ်သည်။" },
      { id: 4, textJP: "(4) <ruby>書類検査<rt>しょるいけんさ</rt></ruby>で<ruby>不合格<rt>ふごうかく</rt></ruby>となった<ruby>場合<rt>ばあい</rt></ruby>は、その<ruby>検査項目<rt>けんさこうもく</rt></ruby>に<ruby>対<rt>たい</rt></ruby>して<ruby>抜取率 30%<rt>ぬきとりりつさんじゅっぱーせんと</rt></ruby>で、<ruby>対物<rt>たいぶつ</rt></ruby>による<ruby>寸法検査<rt>すんぽうけんさ</rt></ruby>を<ruby>行<rt>おこな</rt></ruby>う。", textMY: "(4) စာရွက်စာတမ်း စစ်ဆေးမှုတွင် မအောင်မြင်ပါက ထိုစစ်ဆေးသည့်အချက်အတွက် နမူနာ ၃၀% ဖြင့် ပစ္စည်းစစ်ဆေးမှု အတိုင်းအတာစစ်ဆေးခြင်းကို ဆောင်ရွက်ရမည်။" },
      { id: 5, textJP: "(5) <ruby>検査<rt>けんさ</rt></ruby>の<ruby>結果、限界許容差、<rt>けっか、げんかいきょようさ</rt></ruby>または<ruby>特記<rt>とっき</rt></ruby>のある<ruby>場合<rt>ばあい</rt></ruby>にはその<ruby>許容差<rt>きょようさ</rt></ruby>を<ruby>超<rt>こ</rt></ruby>えて<ruby>不適合<rt>ふてきごう</rt></ruby>となった<ruby>製品<rt>せいひん</rt></ruby>は、<ruby>修正<rt>しゅうせい</rt></ruby>または<ruby>再製作等<rt>さいせいさくとう</rt></ruby>の<ruby>処置<rt>しょち</rt></ruby>を<ruby>行<rt>おこな</rt></ruby>い、<ruby>再検査<rt>さいけんさ</rt></ruby>する。", textMY: "(5) စစ်ဆေးမှုရလဒ်တွင် နောက်ဆုံးကန့်သတ် ခွင့်ပြုလွဲချော်မှု (限界許容差) သို့မဟုတ် သီးသန့်သတ်မှတ်ချက်ပါ ခွင့်ပြုလွဲချော်မှုထက် ကျော်လွန်၍ မကိုက်ညီသော ထုတ်ကုန်များကို ပြင်ဆင်ခြင်း သို့မဟုတ် ပြန်လည်ထုတ်လုပ်ခြင်းများ ပြုလုပ်ပြီး ပြန်လည်စစ်ဆေးရမည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    explanation: {
      ...
      memoryTipMY: "အတိုင်းအတာ (Dimensions) ကို အားလုံး (100%) စစ်ဆေးရမည်။"
    }
  }
];
