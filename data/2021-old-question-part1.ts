...
export const chapter2021Part1Data: StudyCardData[] = [
  {
    ...
    questionMY: "ပုံတွင်ပြထားသည့်အတိုင်း ဘောင်အဆောက်အဦ၏ B အမှတ်၌ အလျားလိုက်ဝန် P သက်ရောက်သောအခါ၊ ဘယ်ဘက်ရှိ ထောက်ကန်အမှတ် (Support) A တွင် ဘယ်ဘက်သို့ဦးတည်သော အလျားလိုက်တုံ့ပြန်အား H<sub>A</sub> နှင့် အောက်သို့ဦးတည်သော ဒေါင်လိုက်တုံ့ပြန်အား V<sub>A</sub> တို့ ဖြစ်ပေါ်လာမည်ဖြစ်ပြီး၊ ညာဘက်ရှိ ထောက်ကန်အမှတ် E တွင် အပေါ်သို့ဦးတည်သော ဒေါင်လိုက်တုံ့ပြန်အား V<sub>E</sub> ဖြစ်ပေါ်လာသည်။ ဤအခြေအနေ၌၊ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း။",
    options: [
      { id: 1, textJP: "(1) <ruby>外力<rt>がいりょく</rt></ruby>Pと<ruby>水平反力<rt>すいへいはんりょく</rt></ruby>H<sub>A</sub>の<ruby>大<rt>おお</rt></ruby>きさは<ruby>等<rt>ひと</rt></ruby>しい。", textMY: "ပြင်ပဝန် P နှင့် အလျားလိုက်တုံ့ပြန်အား H<sub>A</sub> တို့၏ ပမာဏသည် တူညီသည်။" },
      { id: 2, textJP: "(2) <ruby>鉛直反力<rt>えんちょくはんりょく</rt></ruby>V<sub>A</sub>とV<sub>E</sub>の<ruby>大<rt>おお</rt></ruby>きさは<ruby>等<rt>ひと</rt></ruby>しい。", textMY: "ဒေါင်လိုက်တုံ့ပြန်အား V<sub>A</sub> နှင့် V<sub>E</sub> တို့၏ ပမာဏသည် တူညီသည်။" },
      { id: 3, textJP: "(3) <ruby>柱梁接合部<rt>ちゅうはりせつごうぶ</rt></ruby>D<ruby>点<rt>てん</rt></ruby>は、<ruby>荷重<rt>かじゅう</rt></ruby>Pが<ruby>作用<rt>さよう</rt></ruby>することによって<ruby>右方向<rt>みぎほうこう</rt></ruby>に<ruby>移動<rt>いどう</rt></ruby>する。", textMY: "တိုင်နှင့်ရက်မ ဆက်စပ်သည့် D အမှတ်သည် ဝန် P သက်ရောက်ခြင်းကြောင့် ညာဘက်သို့ ရွေ့လျားသည်။" },
      ...
      { id: 5, textJP: "(5) <ruby>曲<rt>ま</rt></ruby>げモーメントが<ruby>最<rt>もっと</rt></ruby>も<ruby>大<rt>おお</rt></ruby>きくなるのはC<ruby>点<rt>てん</rt></ruby>である。", textMY: "ကွေးညွှတ်မိုးမင့် (Bending Moment) အကြီးဆုံး ဖြစ်ပေါ်သည့်အမှတ်မှာ C အမှတ်ဖြစ်သည်။" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 反力 (Reaction Force)",
      reasonMY: "ထောက်ကန်အမှတ် E (Support E) သည် ရိုလာထောက်ကန် (Roller Support) သို့မဟုတ် ပင်ထောက်ကန် (Pin Support) ဖြစ်နိုင်ပြီး၊ ဒေါင်လိုက်တုံ့ပြန်အား (V_E) သာရှိသည်ဟု ဖော်ပြထားသော်လည်း၊ ပုံမှန်အားဖြင့် အဆောက်အဦတစ်ခုလုံး၏ တည်ငြိမ်မှုအတွက် အလျားလိုက်ရွေ့လျားမှုကို ထိန်းချုပ်ထားလေ့ရှိသည်။ သို့သော် ဤမေးခွန်း၏ ရည်ရွယ်ချက်အရ ထောက်ကန်အမှတ်များသည် အောက်ခြေတွင် ခိုင်မြဲစွာတပ်ဆင်ထားသည်ဟု ယူဆရမည်ဖြစ်ရာ၊ ညာဘက်သို့ ရွေ့လျားခြင်းမရှိပါ။",
      memoryTipMY: "ထောက်ကန်အမှတ် (Support) များသည် အလွယ်တကူ မရွေ့နိုင်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-2",
    ...
    questionMY: "ပုံတွင်ပြထားသော Truss ဘောင်ပေါ်သို့ သက်ရောက်သည့် ညီညာစွာပျံ့နှံ့နေသောဝန် (Uniformly Distributed Load) နှင့်ပတ်သက်၍၊ အ, ဣ, ဥ ဟူသော အစိတ်အပိုင်းများတွင် ဖြစ်ပေါ်လာသည့် ဝင်ရိုးတလျှောက်သက်ရောက်အား (Axial Force) များ၏ ပေါင်းစပ်မှုအနက် မှန်ကန်သည့်အရာမှာ အဘယ်နည်း。",
    options: [
    ...
    explanation: {
      ...
      reasonMY: "Truss အဆောက်အဦများတွင် အပေါ်ဘက်ရှိ အစိတ်အပိုင်းများ (Top Chords) သည် ဖိအား (Compression) ကို ခံရလေ့ရှိပြီး၊ အောက်ဘက်ရှိ အစိတ်အပိုင်းများ (Bottom Chords) သည် ဆွဲအား (Tension) ကို ခံရလေ့ရှိသည်။ ဒေါင်လိုက်တိုင် (Vertical Member) 'ဣ' သည် ဤပုံစံတွင် ဝန်မရှိသောအစိတ်အပိုင်း (Zero Force Member) ဖြစ်သည်။",
      memoryTipMY: "Truss တွင် အပေါ်ပိုင်းက ဖိအား (Compression)၊ အောက်ပိုင်းက ဆွဲအား (Tension) ခံရသည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-3",
    ...
    questionMY: "အဆောက်အဦတည်ဆောက်မှုပုံစံဒီဇိုင်း (Structural Design) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း။",
    options: [
      { id: 1, textJP: "(1) <ruby>鉄骨構造<rt>てっこつこうぞう</rt></ruby>では<ruby>建物<rt>たてもの</rt></ruby>の<ruby>強度<rt>きょうど</rt></ruby>だけでなく、<ruby>日常<rt>にちじょう</rt></ruby><ruby>的<rt>てき</rt></ruby>に<ruby>作用<rt>さよう</rt></ruby>する<ruby>荷重<rt>かじゅう</rt></ruby>に<ruby>対<rt>たい</rt></ruby>する<ruby>変形<rt>へんけい</rt></ruby>について<ruby>考慮<rt>こうりょ</rt></ruby>することも<ruby>重要<rt>じゅうよう</rt></ruby>である。", textMY: "သံမဏိကိုယ်ထည်အဆောက်အဦများတွင် အဆောက်အဦ၏ ခံနိုင်ရည်အပြင် နေ့စဉ်သက်ရောက်သော ဝန်များကြောင့် ဖြစ်ပေါ်သည့် ပုံပျက်ခြင်းများကိုလည်း ထည့်သွင်းစဉ်းစားရန် အရေးကြီးသည်။" },
      { id: 2, textJP: "(2) 鋼材は高い靭性を有しているため、座屈や脆性破壊が生じなければ大地震時においても優れた耐震性能を発揮する。", textMY: "သံမဏိသည် မြင့်မားသော ပျော့ပျောင်းကြံ့ခိုင်မှု (Toughness) ရှိသောကြောင့် ကွေးညွှတ်ယိုင်လဲခြင်း (Buckling) သို့မဟုတ် ကြွပ်ဆတ်စွာကျိုးပျက်ခြင်း (Brittle Fracture) မဖြစ်ပါက ပြင်းထန်သော ငလျင်ဒဏ်တွင်ပင် ကောင်းမွန်သော ငလျင်ဒဏ်ခံနိုင်စွမ်း ရှိသည်။" },
      { id: 3, textJP: "(3) 許容応力度設計法は、建物に作用する外力に対し、骨組全体が弾性範囲に留まることを目標とする。", textMY: "ခွင့်ပြုဒဏ်ခံနိုင်ရည်ဒီဇိုင်းနည်းစနစ် (Allowable Stress Design Method) သည် အဆောက်အအုံပေါ် သက်ရောက်သော ပြင်ပဝန်များအတွက် ဖွဲ့စည်းပုံတစ်ခုလုံးအား ပုံမှန်ပြန်ဖြစ်နိုင်သောအတိုင်းအတာ (Elastic Range) အတွင်း၌သာ ရှိနေစေရန် ရည်ရွယ်သည်။" },
      { id: 4, textJP: "(4) 鉄骨造の建物は鉄筋コンクリート造の建物に比べて自重が大きくなるため、地震時の設計荷重も大きくなる。", textMY: "သံမဏိအဆောက်အဦများသည် RC (သံကူကွန်ကရစ်) အဆောက်အဦများနှင့် နှိုင်းယှဉ်လျှင် ကိုယ်အလေးချိန် ပိုများပြီး ငလျင်ဒီဇိုင်းဝန်လည်း ပိုများသည်။" },
      { id: 5, textJP: "(5) 溶接接合部の品質は構造全体の安全性に大きく影響するため、設計段階から溶接の施工性を考慮することが重要である。", textMY: "ဂဟေဆက်ထားသောအပိုင်းများ၏ အရည်အသွေးသည် တည်ဆောက်ပုံတစ်ခုလုံး၏ ဘေးကင်းလုံခြုံမှုအပေါ် ကြီးမားစွာ သက်ရောက်မှုရှိသောကြောင့် ဒီဇိုင်းအဆင့်မှစ၍ ဂဟေဆက်နိုင်စွမ်းကို ထည့်သွင်းစဉ်းစားရန် အရေးကြီးသည်။" }
    ],
    correctOptionId: 4,
    explanation: {
      ...
      memoryTipMY: "Steel သည် RC ထက် ပေါ့ပါးသဖြင့် ငလျင်ဒဏ်သက်ရောက်မှု ပိုနည်းသည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-4",
    ...
    questionMY: "ပုံတွင်ပြထားသည့်အတိုင်း ဘောင်အဆောက်အဦ၏ တိုင်ခြေ (Column Base) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
      { id: 1, textJP: "(1) <ruby>露出形式<rt>ろしゅつけいしき</rt></ruby>の<ruby>柱脚<rt>ちゅうきゃく</rt></ruby>である。", textMY: "ဤသည်မှာ ဖော်ပြထားသောပုံစံ (Exposed Type) တိုင်ခြေ ဖြစ်သည်။" },
      { id: 2, textJP: "(2) <ruby>柱<rt>はしら</rt></ruby>に<ruby>作用<rt>さよう</rt></ruby>する<ruby>軸力<rt>じくりょく</rt></ruby>と<ruby>曲<rt>ま</rt></ruby>げモーメントは、ベースプレートを<ruby>通<rt>とお</rt></ruby>して<ruby>基礎<rt>きそ</rt></ruby>に<ruby>伝達<rt>でんたつ</rt></ruby>される。", textMY: "တိုင်ပေါ်သို့ သက်ရောက်သော ဝင်ရိုးတလျှောက်သက်ရောက်အားနှင့် ကွေးညွှတ်မိုးမင့်တို့ကို Base Plate မှတဆင့် အုတ်မြစ် (Foundation) သို့ သယ်ဆောင်သည်။" },
      { id: 3, textJP: "(3) <ruby>柱<rt>はしら</rt></ruby>に<ruby>作用<rt>さよう</rt></ruby>するせん<ruby>断力<rt>だんりょく</rt></ruby>は、アンカーボルトで<ruby>基礎<rt>きそ</rt></ruby>に<ruby>伝達<rt>でんたつ</rt></ruby>される。", textMY: "တိုင်ပေါ်သို့ သက်ရောက်သော ဖြတ်အား (Shear Force) ကို Anchor Bolt များမှတဆင့် အုတ်မြစ်သို့ သယ်ဆောင်သည်။" },
      { id: 4, textJP: "(4) <ruby>柱<rt>はしら</rt></ruby>に<ruby>作用<rt>さよう</rt></ruby>する<ruby>引張力<rt>ひっぱりりょく</rt></ruby>は、アンカーボルトで<ruby>基礎<rt>きそ</rt></ruby>に<ruby>伝達<rt>でんたつ</rt></ruby>される。", textMY: "တိုင်ပေါ်သို့ သက်ရောက်သော ဆွဲအား (Tension Force) ကို Anchor Bolt များမှတဆင့် အုတ်မြစ်သို့ သယ်ဆောင်သည်။" },
      { id: 5, textJP: "(5) ベースプレートの<ruby>厚<rt>あつ</rt></ruby>さは、<ruby>柱<rt>はしら</rt></ruby>の<ruby>軸力<rt>じくりょく</rt></ruby>と<ruby>曲<rt>ま</rt></ruby>げモーメントによって<ruby>決<rt>き</rt></ruby>まる。", textMY: "Base Plate ၏ အထူသည် တိုင်၏ ဝင်ရိုးတလျှောက်သက်ရောက်အားနှင့် ကွေးညွှတ်မိုးမင့်တို့အပေါ် မူတည်၍ ဆုံးဖြတ်သည်။" }
    ],
    correctOptionId: 3,
    explanation: {
        titleMY: "ရှင်းလင်းချက် - 露出柱脚 (Exposed Column Base)",
        reasonMY: "Exposed Type Column Base တွင် တိုင်ပေါ်သို့ သက်ရောက်သော ဖြတ်အား (Shear Force) ကို အဓိကအားဖြင့် Base Plate နှင့် အုတ်မြစ်ကြားရှိ ပွတ်တိုက်အား (Friction) ဖြင့် သယ်ဆောင်သည်။ Anchor Bolt များသည် အဓိကအားဖြင့် ဆွဲအား (Tension Force) ကို သယ်ဆောင်ရန် ဒီဇိုင်းထုတ်ထားခြင်းဖြစ်သည်။",
        memoryTipMY: "Shear Force ကို Friction က သယ်ဆောင်ပြီး၊ Anchor Bolt က Tension ကို သယ်ဆောင်သည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-5",
    ...
    questionMY: "ပုံတွင်ပြထားသော ဝန်သက်ရောက်နေသည့် ရိုးရှင်းသောရက်မ (Simple Beam) ၏ ကွေးညွှတ်မိုးမင့်ပြပုံ (Bending Moment Diagram) အဖြစ် မှန်ကန်သောအရာမှာ အောက်ပါတို့အနက် အဘယ်နည်း။ သို့ရာတွင် ကွေးညွှတ်မိုးမင့်ကို ဆွဲအားသက်ရောက်ရာဘက် (Tension Side) တွင် ရေးဆွဲရမည်。",
    options: [
    ...
    explanation: {
      ...
      memoryTipMY: "အလယ်တွင် Point Load သက်ရောက်ပါက တြိဂံပုံ Bending Moment Diagram ရရှိမည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-6",
    ...
    questionMY: "သစ်သားအဆောက်အဦများ၏ အဆောက်အဦတည်ဆောက်မှုပုံစံဒီဇိုင်း (Structural Design) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
      ...
      { id: 4, textJP: "(4) <ruby>土台<rt>どだい</rt></ruby>は、<ruby>基礎<rt>きそ</rt></ruby>にアンカーボルトで<ruby>緊結<rt>きんけつ</rt></ruby>する。", textMY: "အောက်ခြေတန်း (Sill) ကို အုတ်မြစ် (Foundation) တွင် Anchor Bolt များဖြင့် ခိုင်မြဲစွာ ချိတ်ဆက်ရမည်。" },
    ...
    explanation: {
      ...
      memoryTipMY: "သစ်သားသည် စိုနေလျှင် ပျော့ပြီး、 ခြောက်သွေ့မှသာ မာကျောသည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-7",
    ...
    explanation: {
      ...
      memoryTipMY: "ဂဟေဆက်ခြင်းသည် သံထည်အလေးချိန်ကို လျော့ကျစေသည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-8",
    ...
    questionMY: "အဆောက်အဦတည်ဆောက်ရေးသုံး သံမဏိ (SN Steel) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
    ...
    explanation: {
      ...
      memoryTipMY: "SN-A တွင် Weldability မရှိသဖြင့် အဓိကနေရာများတွင် မသုံးရဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-9",
    ...
    explanation: {
      ...
      memoryTipMY: "အေးသောအခါ သံသည် ကြွပ်ဆတ်သွားသဖြင့် Charpy Energy ကျဆင်းသွားသည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-10",
    ...
    questionMY: "「JASS 6」ပါ နည်းပညာဆိုင်ရာ ဝေါဟာရများနှင့် ၎င်းတို့၏ အဓိပ္ပာယ်ဖွင့်ဆိုချက်များနှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
    ...
    explanation: {
      ...
      memoryTipMY: "社内検査 သည် စက်ရုံမှ ပြုလုပ်သော စစ်ဆေးမှုအားလုံးကို ခြုံငုံခေါ်ဆိုခြင်းဖြစ်သည်ဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-11",
    ...
    explanation: {
      ...
      reasonMY: "ထုတ်လုပ်မှုလုပ်ငန်းစဉ်လမ်းညွှန် (Fabrication Procedure Manual) သည် သက်ဆိုင်ရာ ပရောဂျက်တစ်ခုချင်းစီ၏ သီးခြားသတ်မှတ်ချက် (Special Specifications) များကို ထင်ဟပ်စေရမည်。 ယေဘုယျစံနှုန်းများကိုသာ တိုက်ရိုက်သုံး၍ မရပါ။",
  ...
  },
  {
    ...
    questionMY: "သံမဏိဖြတ်တောက်ခြင်းနှင့် အချောကိုင်ခြင်း (Cutting and Machining) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
      ...
      { id: 5, textJP: "(5) <ruby>鋼材<rt>こうざい</rt></ruby>の<ruby>切断端面<rt>せつだんたんめん</rt></ruby>は、<ruby>鋼種<rt>こうしゅ</rt></ruby>にかかわらず、すべて<ruby>切削加工<rt>せっさくかこう</rt></ruby>を<ruby>行わなければ<rt>おこなわなければ</rt></ruby>ならない。", textMY: "သံဖြတ်ပြီးသား မျက်နှာပြင်အားလုံးကို သံအမျိုးအစားမရွေး အချောကိုင်စက် (Machining) ဖြင့် အမြဲတမ်း ပြန်လည်ပြုပြင်ရမည်。" }
    ],
    correctOptionId: 5,
    explanation: {
      ...
      memoryTipMY: "ဖြတ်ပြီးသားမျက်နှာပြင်တိုင်းကို အချောကိုင်ရန်မလိုဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-14",
    ...
    questionMY: "「JASS 6」ပါ အားမြင့်ဘိုလ်တိုင် (High Strength Bolt) များ၏ ပွတ်တိုက်မျက်နှာပြင် ပြုပြင်ခြင်းနှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
    ...
    explanation: {
      ...
      memoryTipMY: "လက်ဖြင့်ပွတ်ခြင်း (Hand brush) အား ခွင့်မပြုဟု မှတ်သားထားပါ။"
    }
  },
  {
    id: "2021-15",
    ...
    questionMY: "「JASS 6」အရ သံမဏိတွင် အပေါက်ဖောက်ခြင်း (Hole Drilling) နှင့်ပတ်သက်၍ အောက်ပါဖော်ပြချက်များအနက် မသင့်လျော်ဆုံးမှာ အဘယ်နည်း。",
    options: [
    ...
    explanation: {
      ...
      memoryTipMY: "အပေါက်မှားပါက ဂဟေဖြင့်ပိတ်ပြီး ပြန်ဖောက်၍မရဟု မှတ်သားထားပါ။"
    }
  },
];
