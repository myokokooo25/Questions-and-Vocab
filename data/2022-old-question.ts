...
export const chapter2022Data: StudyCardData[] = [
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>表面欠陥<rt>ひょうめんけっかん</rt></ruby>နှင့် <ruby>精度<rt>せいど</rt></ruby>に<ruby>対して行う<rt>たいしておこなう</rt></ruby>。", textMY: "မျက်နှာပြင် ချို့ယွင်းချက်များနှင့် အတိုင်းအတာ တိကျမှုတို့ကို စစ်ဆေးရမည်။" },
      { id: 2, textJP: "(2) <ruby>対象範囲<rt>たいしょうはんい</rt></ruby>သည် <ruby>全溶接部<rt>ぜんようせつぶ</rt></ruby>である。", textMY: "ဂဟေဆက်ထားသော နေရာများအားလုံးကို ခြွင်းချက်မရှိ စစ်ဆေးရမည်။" },
      { id: 3, textJP: "(3) <ruby>目視検査<rt>もくしけんさ</rt></ruby>ကို <ruby>基本<rt>きほん</rt></ruby>とする。", textMY: "သာမန်မျက်စိဖြင့် ကြည့်ရှုစစ်ဆေးခြင်း (Visual inspection) ကို အခြေခံအဖြစ် လုပ်ဆောင်ရမည်။" },
      { id: 4, textJP: "(4) <ruby>割れ<rt>われ</rt></ruby>が<ruby>確認<rt>かくにん</rt></ruby>されたら<ruby>抜取方法<rt>ぬきとりほうほう</rt></ruby>ကို <ruby>協議<rt>きょうぎ</rt></ruby>する。", textMY: "အက်ကွဲကြောင်း (Crack) တွေ့ရှိပါက မည်ကဲ့သို့ နမူနာကောက်ယူစစ်ဆေးမည်ကို တိုင်ပင်ဆွေးနွေးရမည်။" },
      { id: 5, textJP: "(5) <ruby>不合格箇所<rt>ふごうかくかしょ</rt></ruby>သည် <ruby>補修<rt>ほしゅう</rt></ruby>し<ruby>再検査<rt>さいけんさ</rt></ruby>する。", textMY: "စစ်ဆေးမှု မအောင်မြင်သော နေရာများကို ပြုပြင်ပြီးနောက် မဖြစ်မနေ ပြန်လည်စစ်ဆေးရမည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>アンダーカット<rt>あんだーかっと</rt></ruby>သည် 0.3mm <ruby>以下<rt>いか</rt></ruby>とする。", textMY: "Undercut ၏ အနက်သည် 0.3mm နှင့်အောက် ဖြစ်ရမည်။" },
      { id: 2, textJP: "(2) <ruby>ピット<rt>ぴっと</rt></ruby>သည် 1<ruby>個以下<rt>こいか</rt></ruby>とする。", textMY: "Pit (လေပေါက်) အရေအတွက်သည် ၁ ခုနှင့်အောက် ဖြစ်ရမည်။" },
      { id: 3, textJP: "(3) <ruby>オーバーラップ<rt>おーばーらっぷ</rt></ruby>သည် <ruby>あってはならない<rt>あってはならない</rt></ruby>。", textMY: "Overlap (ဂဟေသားလျှံကျခြင်း) လုံးဝ မရှိစေရပါ။" },
      { id: 4, textJP: "(4) <ruby>余盛高さ<rt>よもりたかさ</rt></ruby>သည် 3mm <ruby>以下<rt>いか</rt></ruby>とする。", textMY: "ဂဟေဖောင်းကြွမှုအမြင့် (Reinforcement height) သည် 3mm နှင့်အောက် ဖြစ်ရမည်။" },
      { id: 5, textJP: "(5) <ruby>脚長不足<rt>きゃくちょうふそく</rt></ruby>သည် 10% <ruby>以内<rt>いない</rt></ruby>なら<ruby>合格<rt>ごうかく</rt></ruby>とする。", textMY: "ဂဟေခြေထောက်အရှည် (Leg length) သည် သတ်မှတ်ပမာဏ၏ ၁၀% အထိ လျော့နည်းသော်လည်း အောင်မြင်သည်ဟု သတ်မှတ်မည်။" }
    ],
    correctOptionId: 5,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 脚長の許容差 (Leg length ခွင့်ပြုဘောင်)",
      reasonMY: "ဂဟေခြေထောက်အရှည် (Leg length) သည် ဒီဇိုင်းသတ်မှတ်ထားသည့် အရွယ်အစားထက် လုံးဝ (လုံးဝ) လျော့နည်းခြင်း မရှိရပါ။ လျော့နည်းပါက ခံနိုင်ရည်ကျဆင်းမည် ဖြစ်သည်။",
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>放射線透過試験<rt>ほうしゃせんとうかしけん</rt></ruby>သည် <ruby>欠陥<rt>けっかん</rt></ruby>က <ruby>濃く写る<rt>こくうつる</rt></ruby>。", textMY: "Radiographic Testing (RT) တွင် ချို့ယွင်းချက်ရှိသော နေရာကို ဖလင်ပေါ်တွင် ပိုမည်းနက်စွာ မြင်တွေ့ရသည်။" },
      { id: 2, textJP: "(2) <ruby>超音波探傷<rt>ちょうおんぱたんしょう</rt></ruby>သည် <ruby>反射波<rt>はんしゃは</rt></ruby>ကို <ruby>受信<rt>じゅしん</rt></ruby>する。", textMY: "Ultrasonic Testing (UT) သည် အသံလှိုင်း၏ ပဲ့တင်ပြန်ကန်မှု (Echo) ကို လက်ခံရယူ၍ စစ်ဆေးသည်။" },
      { id: 3, textJP: "(3) <ruby>垂直探傷<rt>すいちょくたんしょう</rt></ruby>နှင့် <ruby>斜角探傷<rt>しゃかくたんしょう</rt></ruby>がある。", textMY: "UT တွင် တည့်မတ်စွာစစ်ဆေးသော Straight beam နည်းနှင့် စောင်း၍စစ်ဆေးသော Angle beam နည်းဟူ၍ ရှိသည်။" },
      { id: 4, textJP: "(4) <ruby>一般的<rt>いっぱんてき</rt></ruby>な<ruby>鉄骨溶接<rt>てっこつようせつ</rt></ruby>သည် <ruby>垂直探傷<rt>すいちょくたんしょう</rt></ruby>ကို <ruby>用いる<rt>もちいる</rt></ruby>。", textMY: "ယေဘုယျအားဖြင့် သံမဏိတည်ဆောက်ပုံ ဂဟေဆက်များကို စစ်ဆေးရာတွင် Straight beam နည်းကို အသုံးပြုလေ့ရှိသည်။" },
      { id: 5, textJP: "(5) <ruby>磁粉探傷<rt>じふんたんしょう</rt></ruby>သည် <ruby>微細な鉄粉<rt>びさいなてっぷん</rt></ruby>ကို <ruby>吸着<rt>きゅうちゃく</rt></ruby>させる。", textMY: "Magnetic Particle Testing (MT) သည် သံလိုက်မှုန်လေးများကို စုပ်ယူကပ်ငြိစေခြင်းဖြင့် အက်ကွဲကြောင်းကို ရှာဖွေသည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) 300<ruby>箇所以下<rt>かしょいか</rt></ruby>で1<ruby>ロット<rt>ろっと</rt></ruby>とする。", textMY: "စစ်ဆေးမည့်နေရာ ३၀၀ နှင့်အောက်ကို စစ်ဆေးမှုအုပ်စု (Lot) တစ်ခုအဖြစ် သတ်မှတ်သည်။" },
      { id: 2, textJP: "(2) 100<ruby>箇所以下<rt>かしょいか</rt></ruby>သည် <ruby>類似部位<rt>るいじぶい</rt></ruby>နှင့် <ruby>構成<rt>こうせい</rt></ruby>できる。", textMY: "နေရာ ၁၀၀ နှင့်အောက်ဆိုလျှင် အခြားပုံစံတူ အစိတ်အပိုင်းများနှင့် ပေါင်း၍ Lot ဖွဲ့စည်းနိုင်သည်။" },
      { id: 3, textJP: "(3) <ruby>現場溶接<rt>げんばようせつ</rt></ruby>သည် <ruby>節<rt>ふし</rt></ruby>ごとに<ruby>ロット構成<rt>ろっとこうせい</rt></ruby>する。", textMY: "အလုပ်ခွင် (Site) တွင် ဂဟေဆက်သောနေရာများကို အဆစ်အလွှာ (Tier/節) အလိုက် Lot ဖွဲ့စည်းရမည်။" },
      { id: 4, textJP: "(4) <ruby>エコー高さ<rt>えこーたかさ</rt></ruby>ဖြင့် <ruby>判断<rt>はんだん</rt></ruby>する。", textMY: "ချို့ယွင်းချက်ကို Echo ၏ အမြင့်ပမာဏပေါ် မူတည်ပြီး အကဲဖြတ်ဆုံးဖြတ်သည်။" },
      { id: 5, textJP: "(5) <ruby>合否判定<rt>ごうひはんてい</rt></ruby>သည် 2<ruby>回抜取<rt>かいぬきとり</rt></ruby>による。", textMY: "အောင်မြင်/ရှုံးနိမ့် ဆုံးဖြတ်ချက်ကို နမူနာ ၂ ကြိမ် (2回抜取) ထုတ်ယူစစ်ဆေးသည့် နည်းလမ်းဖြင့် လုပ်ဆောင်သည်။" }
    ],
    correctOptionId: 5,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>産業用ロボット<rt>さんぎょうようろぼっと</rt></ruby>သည် <ruby>大臣<rt>だいじん</rt></ruby>က <ruby>定める<rt>さだめる</rt></ruby>。", textMY: "စက်မှုလုပ်ငန်းသုံး စက်ရုပ်များနှင့်ပတ်သက်သည့် စံနှုန်းများကို သက်ဆိုင်ရာဝန်ကြီးက သတ်မှတ်ပြဋ္ဌာန်းသည်။" },
      { id: 2, textJP: "(2) <ruby>快適職場環境<rt>かいてきしょくばかんきょう</rt></ruby>ကို <ruby>目的<rt>もくてき</rt></ruby>とする。", textMY: "အလုပ်သမားများအတွက် သက်တောင့်သက်သာရှိသော အလုပ်ပတ်ဝန်းကျင် (Comfortable workplace) ဖန်တီးရန် ရည်ရွယ်သည်။" },
      { id: 3, textJP: "(3) <ruby>監督官<rt>かんトクかん</rt></ruby>သည် <ruby>作業中止命令<rt>さぎょうちゅうしめいれい</rt></ruby>၏ <ruby>権限<rt>けんげん</rt></ruby>がある。", textMY: "စစ်ဆေးရေးအရာရှိ (監督官) တွင် အန္တရာယ်ရှိပါက လုပ်ငန်းများ ချက်ချင်းရပ်ဆိုင်းရန် အမိန့်ပေးနိုင်သည့် အာဏာရှိသည်။" },
      { id: 4, textJP: "(4) 300<ruby>人以上<rt>にんいじょう</rt></ruby>သည် <ruby>総括責任者<rt>そうかつせきにんしゃ</rt></ruby>၏ <ruby>選任義務<rt>せんにんぎむ</rt></ruby>がある。", textMY: "အလုပ်သမား ၃၀၀ နှင့်အထက်ရှိပါက ဘေးကင်းရေးတာဝန်ခံချုပ် (総括安全衛生管理者) ခန့်အပ်ရန် တာဝန်ရှိသည်။" },
      { id: 5, textJP: "(5) <ruby>元方事業者<rt>もとかたじぎょうしゃ</rt></ruby>သည် <ruby>人数に関わらず安全管理者<rt>にんずうにかかわらずあんぜんかんりしゃ</rt></ruby>ကို <ruby>選任<rt>せんにん</rt></ruby>する。", textMY: "အဓိကကန်ထရိုက်တာ (Main Contractor) သည် လူဦးရေမည်မျှပင်ရှိစေကာမူ ဘေးကင်းရေးမန်နေဂျာကို မဖြစ်မနေ ခန့်အပ်ရမည်။" }
    ],
    correctOptionId: 5,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>屋外作業<rt>おくがいさぎょう</rt></ruby>သည် <ruby>保護具着用<rt>ほごぐちゃくよう</rt></ruby>က <ruby>不要<rt>ふよう</rt></ruby>である。", textMY: "အဆောက်အဦပြင်ပ (Outdoor) တွင် လုပ်ကိုင်ပါက အကာအကွယ်ပစ္စည်းများ ဝတ်ဆင်ရန် မလိုအပ်ပါ။" },
      { id: 2, textJP: "(2) <ruby>アーク光<rt>あーくこう</rt></ruby>သည် <ruby>保護めがね<rt>ほごめがね</rt></ruby>ကို <ruby>使用<rt>しよう</rt></ruby>する。", textMY: "Arc ဂဟေမှထွက်သော အလင်းတန်းများကြောင့် မျက်စိမထိခိုက်စေရန် အကာအကွယ်မျက်မှန် တပ်ဆင်ရမည်。" },
      { id: 3, textJP: "(3) <ruby>アース<rt>あーす</rt></ruby>ကို <ruby>完備<rt>かんび</rt></ruby>し<ruby>感電防止<rt>かんでんぼうし</rt></ruby>する。", textMY: "ဓာတ်လိုက်ခြင်းကို ကာကွယ်နိုင်ရန်အတွက် Earth ကြိုး (Ground မြေချကြိုး) ကို သေချာစွာ ချိတ်ဆက်ရမည်。" },
      { id: 4, textJP: "(4) 2m<ruby>以上<rt>いじょう</rt></ruby>သည် <ruby>自動電撃防止装置<rt>じどうでんげきぼうしそうち</rt></ruby>ကို <ruby>使用<rt>しよう</rt></ruby>する。", textMY: "အမြင့် ၂ မီတာနှင့်အထက်တွင် အလုပ်လုပ်ပါက လျှပ်စစ်ရှော့ခ်မဖြစ်စေရန် အလိုအလျောက်ကာကွယ်ရေးကိရိယာကို သုံးရမည်。" },
      { id: 5, textJP: "(5) <ruby>ロボット溶接<rt>ろぼっとようせつ</rt></ruby>သည် <ruby>柵<rt>さく</rt></ruby>ကို <ruby>設ける<rt>もうける</rt></ruby>。", textMY: "စက်ရုပ်များဖြင့် ဂဟေဆက်ပါက လူနှင့် ထိခိုက်မှုမရှိစေရန် အကာအရံ/ခြံစည်းရိုးများ တပ်ဆင်ထားရမည်。" }
    ],
    correctOptionId: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) 1<ruby>トン未満<rt>みまん</rt></ruby>၏ <ruby>玉掛け<rt>たまかけ</rt></ruby>。", textMY: "အလေးချိန် ၁ တန်အောက်ရှိသော ပစ္စည်းများကို ကြိုးချည်ခြင်း (Slinging / 玉掛け)。" },
      { id: 2, textJP: "(2) <ruby>アーク溶接<rt>あーくようせつ</rt></ruby>。", textMY: "Arc Welding (လျှပ်စစ်ဂဟေဆက်ခြင်း) လုပ်ငန်း。" },
      { id: 3, textJP: "(3) <ruby>ガス溶接<rt>がすようせつ</rt></ruby>。", textMY: "Gas Welding (ဓာတ်ငွေ့သုံး၍ ဂဟေဆက်ခြင်း သို့မဟုတ် ဖြတ်တောက်ခြင်း) လုပ်ငန်း。" },
      { id: 4, textJP: "(4) <ruby>砥石取替え<rt>といしとりかえ</rt></ruby>。", textMY: "Grinder ကျောက်ပြား (砥石) များကို ဖြုတ်/တပ် လဲလှယ်ခြင်းလုပ်ငန်း。" },
      { id: 5, textJP: "(5) <ruby>ロボット教示<rt>ろぼっときょうじ</rt></ruby>。", textMY: "စက်မှုသုံးစက်ရုပ်များကို လည်ပတ်ရန် လမ်းညွှန်ချက်ရေးဆွဲခြင်း (Robot Teaching)。" }
    ],
    correctOptionId: 3,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>地震等<rt>じしんとう</rt></ruby>に<ruby>安全<rt>あんぜん</rt></ruby>でなければならない。", textMY: "အဆောက်အဦများသည် ငလျင်ကဲ့သို့သော သဘာဝဘေးအန္တရာယ်များအတွက် ဘေးကင်းလုံခြုံမှုရှိရမည်。" },
      { id: 2, textJP: "(2) <ruby>指定建築材料<rt>していけんちくざいりょう</rt></ruby>ကို <ruby>用いる<rt>もちいる</rt></ruby>。", textMY: "ဥပဒေက သတ်မှတ်ပြဋ္ဌာန်းထားသော ဆောက်လုပ်ရေးပစ္စည်းများကိုသာ အသုံးပြုရမည်。" },
      { id: 3, textJP: "(3) JIS သို့မဟုတ် <ruby>大臣認定<rt>だいじんにんてい</rt></ruby>က <ruby>必要<rt>ひつよう</rt></ruby>。", textMY: "အသုံးပြုမည့် ပစ္စည်းများသည် JIS စံနှုန်းပြည့်မီရန် သို့မဟုတ် သက်ဆိုင်ရာဝန်ကြီး၏ အသိအမှတ်ပြုချက်ရရှိထားရန် လိုအပ်သည်။" },
      { id: 4, textJP: "(4) <ruby>着工後<rt>ちゃっこうご</rt></ruby>に<ruby>申請<rt>しんせい</rt></ruby>する。", textMY: "ဆောက်လုပ်ခွင့်အတည်ပြုချက် (確認申請) ကို အလုပ်စတင်ပြီးနောက်မှ လျှောက်ထားနိုင်သည်။" },
      { id: 5, textJP: "(5) <ruby>許容応力度<rt>きょようおうりょくど</rt></ruby>သည် F/1.5 である。", textMY: "သံမဏိ၏ ရေတိုကာလအတွက် ခွင့်ပြုအား (Short-term Allowable Stress) မှာ ယေဘုယျအားဖြင့် F/1.5 ဖြစ်သည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>赤さび<rt>あかさび</rt></ruby>သည် <ruby>認められている<rt>みとめられている</rt></ruby>。", textMY: "High-tension bolt များဖြင့် ဆက်မည့်နေရာများတွင် ပွတ်တိုက်အားကောင်းစေရန် နီညိုရောင် သံချေးအလွှာ (赤さび) ရှိနေခြင်းကို ခွင့်ပြုထားသည်။" },
      { id: 2, textJP: "(2) <ruby>縁端距離<rt>えんたんきょり</rt></ruby>သည် <ruby>定められている<rt>さだめられている</rt></ruby>。", textMY: "Bolt အပေါက်များဖောက်ရာတွင် အစွန်းမှခွာရမည့် အကွာအဝေး (Edge distance) ကို တိကျစွာ သတ်မှတ်ထားသည်။" },
      { id: 3, textJP: "(3) <ruby>アンダーカット<rt>あんだーかっと</rt></ruby>သည် 0.3mmကို<ruby>超えるもの<rt>こえるもの</rt></ruby>သည် <ruby>一切認められない<rt>いっさいみとめられない</rt></ruby>。", textMY: "အနက် 0.3mm ထက်ကျော်လွန်နေသော Undercut များကို မည်သည့်အခြေအနေတွင်မဆို လုံးဝ ခွင့်မပြုပါ။" },
      { id: 4, textJP: "(4) <ruby>ズレ<rt>ずれ</rt></ruby>သည် <ruby>許容差<rt>きょようさ</rt></ruby>က <ruby>規定<rt>きてい</rt></ruby>されている。", textMY: "တွဲဆက်မည့် အစိတ်အပိုင်းများကြား လွဲချော်မှု (Misalignment) များအတွက် မိမိသဘောဖြင့် မရဘဲ ခွင့်ပြုဘောင် (Tolerance) သတ်မှတ်ထားသည်။" },
      { id: 5, textJP: "(5) <ruby>溶着金属<rt>ようちゃくきんぞく</rt></ruby>သည် <ruby>鋼材の種類<rt>こうざいのしゅるい</rt></ruby>による。", textMY: "ဂဟေလုပ်ငန်းကြောင့် ဖြစ်ပေါ်လာမည့် ဂဟေသား၏ ဂုဏ်သတ္တိများမှာ အသုံးပြုသော သံမဏိအမျိုးအစားပေါ် မူတည်ပါသည်။" }
    ],
    correctOptionId: 3,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - アンダーカットの許容 (Undercut ခွင့်ပြုချက်)",
      reasonMY: "0.3mm အထိ Undercut များကို ယေဘုယျ ခွင့်ပြုသော်လည်း၊ 0.3mm ကျော်သွားပါက လုံးဝခွင့်မပြုခြင်းမျိုးမဟုတ်ဘဲ၊ ဂဟေဆက်ရမည့် နေရာအရေးပါမှု သို့မဟုတ် ပြဿနာအခြေအနေအလိုက် အသေးစိတ်လိုက်လံစစ်ဆေးပြီး သင့်လျော်သလို ဖြေရှင်းနိုင်ပါသည်။ 'လုံးဝ ခွင့်မပြု' ဟု တင်းကြပ်စွာ မဆိုလိုပါ။ (Note: မှားယွင်းသည့်အချက်အဖြစ် ရှာဖွေရမည်)",
