...
export const chapter3Part3Data: StudyCardData[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 5, textJP: "(5) <ruby>溶接部<rt>外観や精度の検査<rt>がいかんやせいどのけんさ</rt></ruby>については、<ruby>有資格者<rt>ゆうしかくしゃ</rt></ruby>が <ruby>従事<rt>じゅうじ</rt></ruby>することが<ruby>望ましい<rt>のぞましい</rt></ruby>。", textMY: "အပြင်ပန်းနှင့် တိကျမှုစစ်ဆေးခြင်းများတွင်လည်း အရည်အချင်းရှိသူများ ပါဝင်ရန် အကြံပြုသည်။" }
    ],
    correctOptionId: 3,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 4, textJP: "(4) <ruby>サンプル<rt>さんぷる</rt></ruby>の<ruby>不適合個数<rt>ふてきごうこすう</rt></ruby>が 1 <ruby>個を加え 4 個未満<rt>こをくわえよんこみまん</rt></ruby>のときは、<ruby>再検査<rt>さいけんさ</rt></ruby>を<ruby>行う<rt>おこなう</rt></ruby>。", textMY: "ချို့ယွင်းချက် ၁ ခုထက်ပိုပြီး ၄ ခုအောက်ဆိုပါက နမူနာ ၂ ဆဖြင့် ပြန်လည်စစ်ဆေးရမည်။" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>カラーが不適切なスタッド<rt>からーがふてきせつなすたっど</rt></ruby>については<ruby>打撃曲げ検査<rt>だげきまげけんさ</rt></ruby>を<ruby>行い<rt>おこない</rt></ruby>、15° <ruby>曲げて割れ<rt>まげてわれ</rt></ruby>が ないものを<ruby>適合<rt>てきごう</rt></ruby>とする。", textMY: "ဂဟေသားမပြည့်စုံပါက ၁၅ ဒီဂရီကွေးပြီး အက်ကွဲမှုမရှိပါက အောင်မြင်သည်ဟု သတ်မှတ်သည်။" },
      ...
      { id: 5, textJP: "(5) <ruby>不適合<rt>ふてきごう</rt></ruby>となった<ruby>場合<rt>ばあい</rt></ruby>は、<ruby>同一ロット<rt>どういつろっと</rt></ruby>からさらに 2 <ruby>本<rt>ほん</rt></ruby>を <ruby>再検査<rt>さいけんさ</rt></ruby>する。", textMY: "မအောင်မြင်ပါက ထိုအုပ်စုထဲမှ နောက်ထပ် ၂ ခုကို ထပ်မံစစ်ဆေးရမည်။" }
    ],
    correctOptionId: 3,
    explanation: {
