...
export const chapter1Data: StudyCardData[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>梁<rt>はり</rt></ruby>の<ruby>曲<rt>ま</rt></ruby>げ<ruby>剛性<rt>ごうせい</rt></ruby>が <ruby>不足<rt>ふそく</rt></ruby>したので、<ruby>梁せい<rt>はりせい</rt></ruby>を 1 <ruby>サイズ大きく<rt>さいずおおきく</rt></ruby>した。", textMY: "Bending Stiffness မလုံလောက်သဖြင့် beam depth ကို တစ်ဆင့် ပိုကြီးအောင်လုပ်ခဲ့သည်။" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>梁<rt>はり</rt></ruby>の<ruby>曲げ剛性<rt>まげごうせい</rt></ruby>が <ruby>不足<rt>ふそく</rt></ruby>したので、<ruby>鋼種<rt>こうしゅ</rt></ruby>はそのままとし<ruby>梁せい<rt>はりせい</rt></ruby>を 1 <ruby>サイズ大きく<rt>さいずおおきく</rt></ruby>した。", textMY: "Bending stiffness မလုံလောက်သဖြင့် beam depth ကို တစ်ဆင့် ပိုကြီးအောင်လုပ်ခဲ့သည်။" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 5, textJP: "(5) B<ruby>種<rt>しゅ</rt></ruby>、および C<ruby>種<rt>しゅ</rt></ruby>では 0℃ シャルピー<ruby>吸収エネルギー<rt>きゅうしゅうエネルギー</rt></ruby>が 27J <ruby>以上<rt>いじょう</rt></ruby>と<ruby>規定<rt>きてい</rt></ruby>されている。", textMY: "B နှင့် C တို့တွင် Charpy energy သည် 27J ကျော်ရမည်ဖြစ်သည်။" }
    ],
    correctOptionId: 3,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 5, textJP: "(5) B<ruby>種<rt>しゅ</rt></ruby>および C<ruby>種<rt>しゅ</rt></ruby>では 0℃ シャルピー<ruby>吸収エネルギー<rt>きゅうしゅうエネルギー</rt></ruby>が 27J <ruby>以上<rt>いじょう</rt></ruby>と<ruby>規定<rt>きてい</rt></ruby>されている。", textMY: "B နှင့် C တို့တွင် Charpy energy နှင့် Carbon equivalent ကန့်သတ်ချက်များ ရှိသည်။" }
    ],
    correctOptionId: 2,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>鋼材<rt>こうざい</rt></ruby>の<ruby>降伏比<rt>こうふくひ</rt></ruby>は <ruby>鋼材<rt>こうざい</rt></ruby>の<ruby>塑性変形性能<rt>そせいへんけいせいのう</rt></ruby>を<ruby>表<rt>あらわ</rt></ruby>す<ruby>指標<rt>しひょう</rt></ruby>のひとつである。", textMY: "Yield ratio သည် ပုံပျက်ခံနိုင်စွမ်းကို ပြသော အညွှန်းတစ်ခု ဖြစ်သည်။" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 5, textJP: "(5) <ruby>引張強さ<rt>ひっぱりつよさ</rt></ruby>は、<ruby>鋼材<rt>こうざい</rt></ruby>の<ruby>温度<rt>おんど</rt></ruby>が <ruby>青熱ぜい性域<rt>せいねつぜいせいいき</rt></ruby>（200℃~300℃）を<ruby>超えた<rt>こえた</rt></ruby>あたりから<ruby>低下<rt>ていか</rt></ruby>する。", textMY: "သံ၏ ခိုင်မာမှုသည် ၃၀၀ ဒီဂရီကျော်ပါက အပူချိန်တက်လာသည်နှင့်အမျှ လျော့ကျသွားသည်။" }
    ],
    correctOptionId: 4,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>炭素当量<rt>たんそとうりょう</rt></ruby>は、<ruby>鋼材<rt>こうざい</rt></ruby>の<ruby>耐食性能<rt>たいしょくせいのう</rt></ruby>が <ruby>高い<rt>たかい</rt></ruby>ことを<ruby>表<rt>あらわ</rt></ruby>す。", textMY: "Carbon Equivalent သည် သံချေးတက်ခံနိုင်ရည်ကို ပြသော အညွှန်းကိန်းဖြစ်သည်။" },
      ...
      { id: 3, textJP: "(3) <ruby>高強度<rt>こうきょうど</rt></ruby>の<ruby>鋼材<rt>こうざい</rt></ruby>は、<ruby>塑性化後<rt>そせいかご</rt></ruby>も<ruby>高い変形性能<rt>たかいへんけいせいのう</rt></ruby>が <ruby>保証<rt>ほしょう</rt></ruby>されている。", textMY: "ခိုင်မာမှုမြင့်သောသံမဏိများသည် ပုံပျက်ပြီးနောက်တွင်လည်း ကောင်းမွန်သော ပုံပျက်ခံနိုင်ရည်ကို အာမခံထားသည်။" },
