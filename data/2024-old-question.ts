...
export const chapter2024Data: StudyCardData[] = [
  ...
  },
  {
    ...
    questionMY: "ဂဟေဆက်နေရာများ၏ အတွင်းပိုင်းချို့ယွင်းချက် (Internal Defects) အား စစ်ဆေးခြင်းနှင့်ပတ်သက်၍ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>超音波探傷検査<rt>ちょうおんぱたんしょうけんさ</rt></ruby>により<ruby>行い<rt>おこない</rt></ruby>、<ruby>規準<rt>きじゅん</rt></ruby>に<ruby>従う<rt>したがう</rt></ruby>。", textMY: "Ultrasonic Testing (UT) ကို အသုံးပြု၍ သတ်မှတ်စံနှုန်းများနှင့်အညီ စစ်ဆေးရမည်။" },
      { id: 2, textJP: "(2) 300<ruby>箇所<rt>かしょ</rt></ruby><ruby>以下<rt>いか</rt></ruby>で1<ruby>検査ロット<rt>けんさろっと</rt></ruby>を<ruby>構成<rt>こうせい</rt></ruby>する。", textMY: "စစ်ဆေးမည့်နေရာ ၃၀၀ နှင့်အောက်ကို စစ်ဆေးမှုအုပ်စု (Lot) တစ်ခုအဖြစ် ဖွဲ့စည်းနိုင်သည်။" },
      { id: 3, textJP: "(3) <ruby>サンプリング<rt>さんぷりんぐ</rt></ruby>は20%<ruby>以上<rt>いじょう</rt></ruby>とし、<ruby>不適合<rt>ふてきごう</rt></ruby>4<ruby>個以上<rt>こいじょう</rt></ruby>で<ruby>不合格<rt>ふごうかく</rt></ruby>とする。", textMY: "နမူနာ ၂၀% နှင့်အထက် ကို ကောက်ယူရမည်ဖြစ်ပြီး၊ ထိုအထဲမှ ချို့ယွင်းချက် ၄ ခုနှင့်အထက် တွေ့ရှိပါက Lot တစ်ခုလုံး မအောင်မြင်ဟု သတ်မှတ်မည်။" },
      { id: 4, textJP: "(4) <ruby>合計<rt>ごうけい</rt></ruby>の<ruby>不適合数<rt>ふてきごうすう</rt></ruby>が4<ruby>個以下<rt>こいか</rt></ruby>のときは<ruby>合格<rt>ごうかく</rt></ruby>とする。", textMY: "နမူနာများတွင် တွေ့ရှိရသော စုစုပေါင်း ချို့ယွင်းချက်အရေအတွက် ၄ ခုနှင့်အောက် (4個以下) ဆိုပါက ယင်း Lot ကို အောင်မြင်သည်ဟု သတ်မှတ်မည်။" },
      { id: 5, textJP: "(5) <ruby>不合格ロット<rt>ふごうかくろっと</rt></ruby>は<ruby>残り全数<rt>のこりぜんすう</rt></ruby>の<ruby>検査<rt>けんさ</rt></ruby>を<ruby>行う<rt>おこなう</rt></ruby>。", textMY: "မအောင်မြင်သော Lot တွင်ပါဝင်သည့်စစ်ဆေးရန်ကျန်နေသေးသော ဂဟေဆက်အားလုံးကို ခြွင်းချက်မရှိ အပြည့်အဝစစ်ဆေးရမည်။" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 内部欠陥の合否判定",
      reasonMY: "များသောအားဖြင့် JASS 6 စံနှုန်းအရ အတွင်းပိုင်းချို့ယွင်းချက်ကို နမူနာစစ်ဆေးရာတွင် ချို့ယွင်းချက်အရေအတွက် '၁ ခု' သို့မဟုတ် '၀ ခု' (1個以下) တွေ့ရှိမှသာ အောင်မြင်သည်ဟု သတ်မှတ်သည်။ '၄ ခုအထိ' ဆိုပြီး ဖြေလျှော့ပေးထားခြင်း မရှိပါ။",
      memoryTipMY: "အတွင်းပိုင်းချို့ယွင်းချက် ၁ ခုအထိပဲ ခွင့်ပြုပါတယ်။ (1個以下)"
    }
  },
  {
    id: "2024-41",
    ...
    questionMY: "JASS 6 တွင် ပြဋ္ဌာန်းထားသော အပြင်ပန်းကြည့်စစ်ဆေးခြင်း (Visual Inspection) နှင့်ပတ်သက်၍ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>ビード幅<rt>びーどはば</rt></ruby>の<ruby>不整<rt>ふせい</rt></ruby>の<ruby>管理許容差<rt>かんりきょようさ</rt></ruby>は5mm<ruby>以下<rt>いか</rt></ruby>である。", textMY: "Bead width (ဂဟေအကျယ်) မညီညာမှု၏ ခွင့်ပြုလွဲချော်မှု (Tolerance) သည် 5mm အောက် ဖြစ်ရမည်。" },
      { id: 2, textJP: "(2) <ruby>ビード幅<rt>びーどはば</rt></ruby>の<ruby>管理許容差<rt>かんりきょようさ</rt></ruby>は<ruby>板厚<rt>いたあつ</rt></ruby>の1.5<ruby>倍以下<rt>ばいいか</rt></ruby>である。", textMY: "Bead width ၏ စီမံခန့်ခွဲမှုလွဲချော်မှုမှာ အသုံးပြုသော သံပြားအထူ၏ ၁.၅ ဆ အောက် ဖြစ်ရမည် ဟု သတ်မှတ်ထားသည်။" },
      { id: 3, textJP: "(3) <ruby>ピット<rt>ぴっと</rt></ruby>の<ruby>管理許容差<rt>かんりきょようさ</rt></ruby>は1<ruby>個以下<rt>こいか</rt></ruby>である。", textMY: "Pit (မျက်နှာပြင်ပေါ်ရှိ လေပေါက်) အရေအတွက် ခွင့်ပြုချက်မှာ နေရာတစ်ခုတွင် ၁ ခုနှင့်အောက်သာ ဖြစ်သည်။" },
      { id: 4, textJP: "(4) <ruby>クレータ割れ<rt>くれーたわれ</rt></ruby>などはあってはならない。", textMY: "ဂဟေအဆုံးသတ်နေရာရှိ အက်ကွဲကြောင်းများ (Crater cracks) သည် မည်သည့်အချိန်တွင်မျှ လုံးဝမပါရှိစေရပါ။" },
      { id: 5, textJP: "(5) <ruby>スタッド<rt>すたっど</rt></ruby>の<ruby>傾き<rt>かたむき</rt></ruby>の<ruby>管理許容差<rt>かんりきょようさ</rt></ruby>は3°<ruby>以下<rt>いか</rt></ruby>である。", textMY: "Stud စောင်းနေမှု (Inclination) ၏ ခွင့်ပြုလွဲချော်နိုင်စွမ်းမှာ ၃ ဒီဂရီ (3°) အထိ ဖြစ်သည်။" }
    ],
    correctOptionId: 2,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - ビード幅の許容差 (Bead Width ခွင့်ပြုချက်)",
      reasonMY: "JASS 6 အရ ဂဟေအကျယ် (Bead width) နှင့်ပတ်သက်သည့် စီမံခန့်ခွဲမှုလွဲချော်မှုများကို တိကျသော ကိန်းဂဏန်းများဖြင့်သာ သတ်မှတ်လေ့ရှိပြီး 'သံပြားအထူ၏ ၁.၅ ဆ' ဟူသော စံနှုန်းမျိုး မရှိပါ။",
      memoryTipMY: "Bead Width မှာ 'သံပြားအထူ၏ ၁.၅ ဆ' လို့လာရင် အမှားပါ။"
    }
  },
  {
    id: "2024-43",
    ...
    questionMY: "အဖျက်အဆီးကင်း စစ်ဆေးမှု (NDT) များနှင့် ၎င်းတို့၏ ဝိသေသလက္ခဏာများဆိုင်ရာ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>放射線<rt>ほうしゃせん</rt></ruby>と<ruby>超音波<rt>ちょうおんぱ</rt></ruby>は<ruby>内部欠陥用<rt>ないぶけっかんよう</rt></ruby>である。", textMY: "Radiographic Testing (RT) နှင့် Ultrasonic Testing (UT) တို့သည် အတွင်းပိုင်းချို့ယွင်းချက်များ ရှာဖွေရာတွင် အဓိကသုံးသည်။" },
      { id: 2, textJP: "(2) <ruby>磁粉<rt>じふん</rt></ruby>と<ruby>浸透<rt>しんとう</rt></ruby>は<ruby>表面欠陥用<rt>ひょうめんけっかんよう</rt></ruby>である。", textMY: "Magnetic Particle Testing (MT) နှင့် Penetrant Testing (PT) တို့သည် မျက်နှာပြင်ချို့ယွင်းချက်များ ရှာဖွေရာတွင် အသုံးပြုသည်။" },
      { id: 3, textJP: "(3) <ruby>磁粉探傷<rt>じふんたんしょう</rt></ruby>では<ruby>表面<rt>ひょうめん</rt></ruby>に<ruby>開口<rt>かいこう</rt></ruby>した<ruby>欠陥以外<rt>けっかんいがい</rt></ruby>の<ruby>検出<rt>けんしゅつ</rt></ruby>は<ruby>困難<rt>こんなん</rt></ruby>である。", textMY: "သံလိုက်မှုန်စစ်ဆေးခြင်း (MT) သည် မျက်နှာပြင်ပေါ်တွင် ဟနေသော (ပွင့်နေသော) အက်ကွဲကြောင်းများမှလွဲ၍ အတွင်းပိုင်းအက်ကွဲကြောင်းများရှာဖွေရန် ခက်ခဲသည်။" },
      { id: 4, textJP: "(4) <ruby>超音波<rt>ちょうおんぱ</rt></ruby>では<ruby>ブローホール<rt>ぶろーほーる</rt></ruby>の<ruby>検出<rt>けんしゅつ</rt></ruby>は<ruby>困難<rt>こんなん</rt></ruby>である。", textMY: "အသံလှိုင်းသုံးစစ်ဆေးခြင်း (UT) ဖြင့် လုံးဝန်းသောလေပေါက်များ (Blowhole) ကို ရှာဖွေတွေ့ရှိရန် ခက်ခဲသည်။" },
      { id: 5, textJP: "(5) <ruby>放射線<rt>ほうしゃせん</rt></ruby>は<ruby>割れ<rt>われ</rt></ruby>の<ruby>検出性<rt>けんしゅつせい</rt></ruby>に<ruby>優れている<rt>すぐれている</rt></ruby>。", textMY: "အက်စရေး/ဓာတ်မှန်ရိုက် စစ်ဆေးခြင်း (RT) သည် အက်ကွဲကြောင်း (Crack) များကို ရှာဖွေဖော်ထုတ်ရာတွင် UT ထက် ပိုမိုထူးကဲကောင်းမွန်သည်။" }
    ],
    correctOptionId: 5,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - RT と割れの検出 (RT ဖြင့် အက်ကွဲကြောင်းရှာဖွေခြင်း)",
      reasonMY: "Radiography (RT) သည် ဓာတ်မှန်ရိုက်ပုံစံဖြစ်၍ Blowhole ကဲ့သို့ အလုံးပုံချို့ယွင်းချက်များကို ကောင်းစွာမြင်နိုင်သော်လည်း၊ များသောအားဖြင့် အလွန်ပါးလွှာသော အက်ကွဲကြောင်း (Crack) များကို ရှာဖွေရာတွင် UT က ပိုမိုထိရောက် ထူးကဲပါသည်။",
      memoryTipMY: "Crack ရှာဖို့ဆိုရင် RT ထက် UT က ပိုကောင်းပါတယ်။"
    }
  },
  {
    id: "2024-44",
    ...
    options: [
      { id: 1, textJP: "(1) <ruby>完全溶込み溶接部<rt>かんぜんすみこみようせつぶ</rt></ruby>および<ruby>部分溶込み溶接部<rt>ぶぶんすみこみようせつぶ</rt></ruby>を<ruby>検査<rt>けんさ</rt></ruby>する。", textMY: "Full penetration နှင့် Partial penetration ဂဟေဆက်များအားလုံးကို စစ်ဆေးနိုင်သည်။" },
      { id: 2, textJP: "(2) <ruby>板厚<rt>いたあつ</rt></ruby>6mm<ruby>未満<rt>みまん</rt></ruby>のものには<ruby>原則<rt>げんそく</rt></ruby>として<ruby>適用<rt>てきよう</rt></ruby>しない。", textMY: "အသုံးပြုထားသော သံပြားအထူ 6mm အောက်ပါးလွှာပါက အခြေခံအားဖြင့် ဤနည်းကို အသုံးမပြုပါ။" },
      { id: 3, textJP: "(3) <ruby>手動<rt>しゅどう</rt></ruby>の<ruby>パルス反射法<rt>ぱるすはんしゃほう</rt></ruby>で<ruby>直接接触法<rt>ちょくせつせっしょくほう</rt></ruby>による。", textMY: "လက်ဖြင့်ပြသသော Pulse reflection method (パルス反射法) ကို အသုံးပြု၍ တိုက်ရိုက်ထိတွေ့စစ်ဆေးသည်။" },
      { id: 4, textJP: "(4) <ruby>接触媒質<rt>せっしょくばいしつ</rt></ruby>は<ruby>グリセリン<rt>ぐりせりん</rt></ruby>などをする。", textMY: "အသံလှိုင်းကူးပြောင်းမှုကောင်းမွန်စေရန် Glycerin ကဲ့သို့သော ကြားခံအရည် (Couplant) ကို သုံးသည်။" },
      { id: 5, textJP: "(5) <ruby>斜角探触子<rt>しゃかくたんしょくし</rt></ruby>の<ruby>屈折角<rt>くっせつかく</rt></ruby>は<ruby>公称<rt>こうしょう</rt></ruby>70°のみとする。", textMY: "Angle beam probe (斜角探触子) ၏ ထောင့်ချိုး (Refraction Angle) မှာ ၇၀ ဒီဂရီ (70°) တစ်မျိုးတည်းသာ ဖြစ်ရမည်。" }
    ],
    correctOptionId: 5,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 斜角探触子 (Angle Probe)",
      reasonMY: "UT စစ်ဆေးရာတွင် အသုံးပြုသော Probe ၏ ထောင့်ချိုးများမှာ သံပြားအထူနှင့် အခြေအနေအလိုက် ၄၅°၊ ၆၀° နှင့် ၇၀° ဟူ၍ အမျိုးမျိုးရှိသည်။ ၇၀° တစ်မျိုးတည်းသာ သုံးရမည်ဆိုခြင်းမှာ မှားယွင်းသည်။",
      memoryTipMY: "UT တွင် ထောင့်အမျိုးမျိုး (၄၅, ၆၀, ၇၀) ရှိသည်။"
    }
  },
  {
    id: "2024-45",
    ...
    questionMY: "ဘေးကင်းလုံခြုံရေးနှင့် ကျန်းမာရေးစီမံခန့်ခွဲမှုဆိုင်ရာ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>度数率<rt>どすうりつ</rt></ruby>နှင့် <ruby>強度率<rt>きょうどりつ</rt></ruby>၏ <ruby>定義<rt>ていぎ</rt></ruby>について", textMY: "ဘေးအန္တရာယ်ဖြစ်ပွားနှုန်း (Frequency rate/度数率) နှင့် ပြင်းအား (Severity rate/強度率) ဆိုင်ရာ အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ ပါဝင်သည်။" },
      { id: 2, textJP: "(2) <ruby>作業主任者<rt>さぎょうしゅにんしゃ</rt></ruby>の<ruby>職務<rt>しょくむ</rt></ruby>について", textMY: "လုပ်ငန်းခွင် ကြီးကြပ်ရေးမှူး/ခေါင်းဆောင် (作業主任者) ၏ တာဝန်ဝတ္တရားများအကြောင်းကို သတ်မှတ်ထားသည်။" },
      { id: 3, textJP: "(3) <ruby>安全管理者<rt>あんぜんかんりしゃ</rt></ruby>は<ruby>直ちに必要<rt>ただちにひつよう</rt></ruby>な<ruby>措置<rt>そち</rt></ruby>を<ruby>講じる<rt>こうじる</rt></ruby>。", textMY: "ဘေးကင်းရေးမန်နေဂျာ (安全管理者) သည် အန္တရာယ်ရှိပါက လိုအပ်သောအစီအမံများကို ချက်ချင်းလုပ်ဆောင်ရန် တာဝန်ရှိသည်။" },
      { id: 4, textJP: "(4) <ruby>衛生管理者<rt>えいせいかんりしゃ</rt></ruby>は30<ruby>人以上<rt>にんいじょう</rt></ruby>の<ruby>事業場<rt>じぎょうじょう</rt></ruby>で<ruby>選任<rt>せんにん</rt></ruby>する。", textMY: "အလုပ်သမားများ၏ ကျန်းမာရေးတာဝန်ခံ (衛生管理者) ကို အလုပ်သမား ၃၀ ဦးနှင့်အထက် ရှိသော လုပ်ငန်းခွင်များတွင် ခန့်အပ်ရမည်。" },
      { id: 5, textJP: "(5) <ruby>産業医<rt>さんぎょうい</rt></ruby>は50<ruby>人以上<rt>にんいじょう</rt></ruby>の<ruby>事業場<rt>じぎょうじょう</rt></ruby>で<ruby>選任<rt>せんにん</rt></ruby>する。", textMY: "စက်မှုနှင့် လုပ်ငန်းခွင်ဆိုင်ရာ ဆရာဝန် (産業医) ကို အလုပ်သမား ၅၀ ဦးနှင့်အထက် ရှိသော လုပ်ငန်းခွင်များတွင် ခန့်အပ်ရမည်。" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 衛生管理者の選任 (Health Manager Appointment)",
      reasonMY: "ဂျပန်နိုင်ငံ၏ အလုပ်သမားဥပဒေအရ ကျန်းမာရေးစီမံခန့်ခွဲသူ (衛生管理者) များကိုလည်း ဘေးကင်းရေးမန်နေဂျာနှင့် ဆရာဝန်များနည်းတူ အလုပ်သမား ၅၀ ဦး နှင့်အထက် ရှိလာသည်နှင့် ခန့်အပ်ရန် သတ်မှတ်ထားပါသည်။ လူ ၃၀ ဦး မဟုတ်ပါ။",
      memoryTipMY: "ကျန်းမာရေးမန်နေဂျာ (Health Manager) လည်း လူ ၅၀ ကျော်မှ စခန့်ရသည်။"
    }
  },
  {
    id: "2024-46",
    ...
    questionMY: "အလုပ်သမားများ၏ အရည်အချင်းနှင့် ပညာပေးသင်တန်းများဆိုင်ရာ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>免許<rt>めんきょ</rt></ruby>には<ruby>クレーン運転士<rt>くれーんうんてんし</rt></ruby>などがある。", textMY: "လိုင်စင် (免許) လိုအပ်သည့်အလုပ်များတွင် ကြီးမားသောကရိန်းမောင်းနှင်သူ (クレーン運転士) ကဲ့သို့သော အလုပ်များ ပါဝင်သည်။" },
      { id: 2, textJP: "(2) <ruby>技能講習<rt>ぎのうこうしゅう</rt></ruby>には<ruby>鉄骨の組立て等作業主任者<rt>てっこつのくみたてとうさぎょうしゅにんしゃ</rt></ruby>がある。", textMY: "ကျွမ်းကျင်မှုသင်တန်း (技能講習) တွင် သံမဏိတည်ဆောက်ပုံ တပ်ဆင်ရေး ကြီးကြပ်သူ (鉄骨の組立て等作業主任者) သင်တန်းများ ပါဝင်သည်။" },
      { id: 3, textJP: "(3) <ruby>特別教育<rt>とくべつきょういく</rt></ruby>には<ruby>ガス溶接<rt>がすようせつ</rt></ruby>などがある。", textMY: "အထူးပညာပေးသင်တန်း (特別教育) အဆင့်ဖြင့် လုပ်ကိုင်နိုင်သည့်အထဲတွင် Gas welding စသည်တို့ ပါဝင်သည်။" },
      { id: 4, textJP: "(4) <ruby>雇入れ時の教育<rt>やといれじのきょういく</rt></ruby>は<ruby>作業場<rt>さぎょうば</rt></ruby>を<ruby>変更<rt>へんこう</rt></ruby>しただけで<ruby>行う<rt>おこなう</rt></ruby>。", textMY: "အလုပ်ခန့်စအချိန်တွင် ပေးရသောသင်တန်း (雇入れ時の教育) ကို အလုပ်နေရာ (Workplace/作業場) အပြောင်းအလဲဖြစ်ရုံမျှဖြင့် မဖြစ်မနေ ထပ်မံပေးရမည်。" },
      { id: 5, textJP: "(5) <ruby>職長等の教育<rt>しょくちょうとうのきょういく</rt></ruby>は<ruby>事業者<rt>じぎょうしゃ</rt></ruby>が<ruby>行う<rt>おこなう</rt></ruby>。", textMY: "လုပ်ငန်းခွင်ခေါင်းဆောင်များ (職長等) အတွက် သင်တန်းပညာပေးခြင်းကို လုပ်ငန်းရှင် (事業者) က တာဝန်ယူပြုလုပ်ပေးရမည်。" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 雇入れ時の教育 (လုပ်ငန်းစတင်ခန့်အပ်ချိန် သင်တန်း)",
      reasonMY: "အလုပ်ခန့်စအချိန်တွင်ပေးသော သင်တန်းသည် အလုပ်အမျိုးအစား ပြောင်းလဲသွားသောအခါမျိုးတွင် လိုအပ်သော်လည်း၊ အလုပ်လုပ်မည့်နေရာ (Site) ပြောင်းရုံမျှဖြင့် ထပ်မံလုပ်ဆောင်ရန် ဥပဒေအရ မလိုအပ်ပါ။",
      memoryTipMY: "အလုပ်အမျိုးအစားပြောင်းမှ သင်တန်းထပ်လိုသည်၊ နေရာပြောင်းရုံဖြင့် မလိုပါ။"
    }
  },
  {
    id: "2024-47",
    ...
    questionMY: "ဂဟေဆက်ခြင်း ဘေးကင်းရေးဆိုင်ရာ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>アーク光<rt>あーくこう</rt></ruby>から<ruby>目<rt>め</rt></ruby>を<ruby>守る<rt>まもる</rt></ruby>ため<ruby>保護めがね<rt>ほごめがね</rt></ruby>を<ruby>使用<rt>しよう</rt></ruby>する。", textMY: "Arc မီးတိုင်မှထွက်သော အလင်းတန်းများကြောင့် မျက်စိမထိခိုက်စေရန် အကာအကွယ်မျက်မှန် သုံးရမည်。" },
      { id: 2, textJP: "(2) 2m<ruby>以上<rt>いじょう</rt></ruby>の<ruby>場所<rt>ばしょ</rt></ruby>では<ruby>自動電撃防止装置<rt>じどうでんげきぼうしそうち</rt></ruby>を<ruby>使用<rt>しよう</rt></ruby>する。", textMY: "အမြင့် ၂ မီတာနှင့်အထက် ရှိသောနေရာများတွင် အလုပ်လုပ်ပါက လျှပ်စစ်ရှော့ခ်ကာကွယ်ရေးကိရိယာ (自動電撃防止装置) ကို မဖြစ်မနေ အသုံးပြုရမည်。" },
      { id: 3, textJP: "(3) <ruby>アース<rt>あーす</rt></ruby>を<ruby>完備<rt>かんび</rt></ruby>し<ruby>感電<rt>かんでん</rt></ruby>を<ruby>防止<rt>ぼうし</rt></ruby>する。", textMY: "Earth ကြိုး (アース) ကို ပြီးပြည့်စုံစွာ ချိတ်ဆက်ပြီး ဓာတ်လိုက်ခြင်းကို ကြိုတင်ကာကွယ်ရမည်。" },
      { id: 4, textJP: "(4) <ruby>屋外作業<rt>おくがいさぎょう</rt></ruby>を<ruby>除き呼吸用保護具<rt>こきゅうようほごぐ</rt></ruby>が<ruby>必要<rt>ひつよう</rt></ruby>である。", textMY: "ပြင်ပလေဟာပြင် အလုပ်များမှလွဲ၍ ကျန်နေရာများတွင် အသက်ရှူလမ်းကြောင်းကာကွယ်ရေးပစ္စည်း (Mask/Respirator) များကို ဝတ်ဆင်ရမည်。" },
      { id: 5, textJP: "(5) <ruby>ヒューム<rt>ひゅーむ</rt></ruby>に<ruby>対して<rt>たいして</rt></ruby>は<ruby>特殊健康診断<rt>とくしゅけんこうしんだん</rt></ruby>などが<ruby>必要<rt>ひつよう</rt></ruby>である。", textMY: "ဂဟေအခိုးအငွေ့ (Fume) များနှင့် ထိတွေ့နေရသူများအတွက် သီးသန့်ကျန်းမာရေးစစ်ဆေးမှု (特殊健康診断) လိုအပ်သည်။" }
    ],
    correctOptionId: 2,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 自動電撃防止装置 (Anti-shock device)",
      reasonMY: "အလိုအလျောက် ရှော့ခ်ကာကွယ်ရေးကိရိယာကို 'အမြင့် ၂ မီတာ' ကြောင့်မဟုတ်ဘဲ၊ 'အလွန်စိုထိုင်းသောနေရာ' သို့မဟုတ် 'သတ္တုနှင့်ကျယ်ကျယ်ပြန့်ပြန့် ထိတွေ့နေရသော ကျဉ်းမြောင်းသည့် နေရာ' များတွင် မဖြစ်မနေ အသုံးပြုရန် ပြဋ္ဌာန်းထားသည်။",
      memoryTipMY: "ရှော့ခ်ကာကွယ်ရေးကိရိယာသည် အမြင့်ထက် နေရာ၏အခြေအနေ (စိုထိုင်းမှု) နှင့် ပိုဆိုင်သည်။"
    }
  },
  {
    id: "2024-48",
    ...
    questionMY: "ဆောက်လုပ်ရေးစံနှုန်းဥပဒေ (建築基準法) နှင့် ပတ်သက်၍ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>最低<rt>さいてい</rt></ruby>の<ruby>基準<rt>きじゅん</rt></ruby>を<ruby>定めた<rt>さだめた</rt></ruby>ものである。", textMY: "ဤဥပဒေသည် အဆောက်အဦများအတွက် မရှိမဖြစ်လိုအပ်သော အနိမ့်ဆုံးစံနှုန်း (最低基準) များကို သတ်မှတ်ထားခြင်းဖြစ်သည်။" },
      { id: 2, textJP: "(2) <ruby>指定確認検査機関<rt>していかくにんけんさきかん</rt></ruby>も<ruby>業務<rt>ぎょうむ</rt></ruby>を<ruby>行える<rt>おこなえる</rt></ruby>。", textMY: "အစိုးရမှ တရားဝင်ခွင့်ပြုထားသော ပုဂ္ဂလိက စစ်ဆေးရေးအဖွဲ့ (指定確認検査機関) များသည်လည်း ဥပဒေလုပ်ငန်းများကို လုပ်ဆောင်နိုင်သည်။" },
      { id: 3, textJP: "(3) <ruby>工事着工前<rt>こうじちゃっこうまえ</rt></ruby>に<ruby>確認済証<rt>かくにんずみしょう</rt></ruby>の<ruby>交付<rt>こうふ</rt></ruby>を<ruby>受ける<rt>うける</rt></ruby>。", textMY: "အဆောက်အဦ မဆောက်လုပ်မီ (工事着工前) တွင် ဆောက်လုပ်ခွင့်အတည်ပြုလက်မှတ် (確認済証) ကို ကြိုတင်ရယူထားရမည်。" },
      { id: 4, textJP: "(4) <ruby>中間検査<rt>ちゅうかんけんさ</rt></ruby>に<ruby>合格<rt>ごうかく</rt></ruby>しなければ<ruby>工事<rt>こうじ</rt></ruby>は<ruby>続行<rt>ぞっこう</rt></ruby>できない。", textMY: "ကြားဖြတ်စစ်ဆေးမှု (中間検査) ကို မအောင်မြင်ပါက နောက်ထပ်ဆက်လက်ဆောက်လုပ်မည့် အလုပ်များကို ဆက်လုပ်ခွင့် မရှိပါ။" },
      { id: 5, textJP: "(5) <ruby>完了検査申請書<rt>かんりょうけんさしんせいしょ</rt></ruby>は<ruby>工事完了後<rt>こうじかんりょうご</rt></ruby>14<ruby>日以内<rt>にちいない</rt></ruby>に<ruby>提出<rt>ていしゅつ</rt></ruby>する。", textMY: "အဆောက်အဦပြီးစီးမှု စစ်ဆေးခြင်း လျှောက်လွှာ (完了検査申請書) ကို အလုပ်ပြီးစီးသည့်နေ့မှစ၍ '၁၄ ရက်အတွင်း' တင်သွင်းရမည်。" }
    ],
    correctOptionId: 5,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 完了検査 (Completion Inspection)",
      reasonMY: "အဆောက်အဦပြီးစီးမှု စစ်ဆေးခြင်း လျှောက်လွှာကို အလုပ်ပြီးစီးပြီးနောက် '၄ ရက်အတွင်း' (4日以内) တင်သွင်းရမည် ဖြစ်သည်။ '၁၄ ရက်' မဟုတ်ပါ။",
  ...
  },
  {
    ...
    questionMY: "ဆောက်လုပ်ရေးစံနှုန်းဥပဒေပါ ဝေါဟာရများနှင့် ပတ်သက်၍ မှားယွင်းသောအချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>構造耐力上主要な部分<rt>こうぞうたいりょくじょうしゅようなぶぶん</rt></ruby>と<ruby>主要構造部<rt>しゅようこうぞうぶ</rt></ruby>は<ruby>異なる<rt>ことなる</rt></ruby>。", textMY: "'ဝန်ထမ်းဆောင်ပေးသော အဓိကအစိတ်အပိုင်း' (構造耐力上主要な部分) နှင့် 'ပင်မဖွဲ့စည်းပုံအစိတ်အပိုင်း' (主要構造部) တို့သည် ကွဲပြားသောအဓိပ္ပာယ်များ ရှိသည်။" },
      { id: 2, textJP: "(2) <ruby>主要構造部<rt>しゅようこうぞうぶ</rt></ruby>は<ruby>防火上<rt>ぼうかじょう</rt></ruby>の<ruby>観点<rt>かんてん</rt></ruby>から<ruby>定められている<rt>さだめられている</rt></ruby>。", textMY: "'ပင်မဖွဲ့စည်းပုံအစိတ်အပိုင်း' ကို အဓိကအားဖြင့် မီးဘေးကာကွယ်ရေး (防火上) ရှုထောင့်မှ အခြေခံ၍ သတ်မှတ်ထားခြင်း ဖြစ်သည်။" },
      { id: 3, textJP: "(3) <ruby>建築<rt>けんちく</rt></ruby>とは<ruby>新築、増築、改築、移転<rt>しんちく、ぞうちく、かいちく、いてん</rt></ruby>をいう。", textMY: "'အဆောက်အဦဆောက်လုပ်ခြင်း' (建築) ဆိုရာတွင် အသစ်ဆောက်ခြင်း၊ တိုးချဲ့ခြင်း၊ ပြင်ဆင်မွမ်းမံခြင်း၊ နှင့် နေရာပြောင်းရွှေ့ခြင်း အားလုံးပါဝင်သည်။" },
      { id: 4, textJP: "(4) <ruby>大規模の修繕<rt>だいきぼのしゅうぜん</rt></ruby>とは、<ruby>すべての主要構造部<rt>すべてのしゅようこうぞうぶ</rt></ruby>を<ruby>修繕<rt>しゅうぜん</rt></ruby>することである。", textMY: "'ကြီးမားသော ပြုပြင်မွမ်းမံမှု' (大規模の修繕) ဆိုသည်မှာ အဆောက်အဦ၏ ပင်မဖွဲ့စည်းပုံအစိတ်အပိုင်းများ အားလုံး (すべて) ကို တစ်ပြိုင်နက်တည်း ပြင်ဆင်ခြင်းဖြစ်သည်။" },
      { id: 5, textJP: "(5) <ruby>敷地<rt>しきち</rt></ruby>とは<ruby>一団の土地<rt>いちだんのとち</rt></ruby>をいう。", textMY: "'မြေကွက်' (敷地) ဆိုသည်မှာ အဆောက်အဦတစ်ခု ဆောက်လုပ်ရာတွင် အသုံးပြုမည့် တစ်ဆက်တည်းဖြစ်နေသော မြေတစ်ကွက်လုံးကို ဆိုလိုသည်။" }
    ],
    correctOptionId: 4,
    explanation: {
      titleMY: "ရှင်းလင်းချက် - 大規模の修繕 (Large-scale Repair)",
      reasonMY: "ကြီးမားသော ပြုပြင်မွမ်းမံမှု ဆိုသည်မှာ ပင်မဖွဲ့စည်းပုံ အစိတ်အပိုင်းများထဲမှ တစ်မျိုးမျိုး၏ 'ထက်ဝက်ကျော်' (過半) ကို ပြုပြင်ခြင်းကို ဆိုလိုသည်။ 'အားလုံး' ပြုပြင်ရမည်ဟု မဆိုလိုပါ။",
      memoryTipMY: "ကြီးမားသော ပြုပြင်မှု = ပင်မအစိတ်အပိုင်းတစ်ခုခု၏ ထက်ဝက်ကျော်။"
    }
  },
  {
    id: "2024-50",
