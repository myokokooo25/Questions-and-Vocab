...
export const chapter3Part2Data: StudyCardData[] = [
  ...
  },
  {
    ...
    explanation: {
      ...
      reasonMY: "Limit Tolerance (限界許容差) သည် ထုတ်ကုန်တစ်ခုစီ၏ အောင်/ရှုံး (Pass/Fail) ကို ဆုံးဖြတ်ရန် အတိအကျသတ်မှတ်ထားသော စံနှုန်းဖြစ်သည်။ ၎င်းကို ကျော်လွန်သော အမှားအယွင်းများကို 'မူအရ (in principle) ခွင့်မပြုပါ' ဟု ခြွင်းချက်ထား၍ ပြောဆိုခြင်း မဟုတ်ဘဲ၊ လုံခြုံရေးအရ 'လုံးဝ ခွင့်မပြုပါ' ဟု ပြတ်သားစွာ သတ်မှတ်ထားခြင်း ဖြစ်သည်။ ထို့ကြောင့် '原則として許されない' ဟု ဖော်ပြထားသော (၁) မှာ မှားယွင်းပါသည်။",
      memoryTipMY: "Limit Tolerance (限界許容差) ဆိုတာ 'လုံးဝ' ကျော်လို့မရတဲ့ အကန့်အသတ်ပါ။"
    }
  },
  {
    id: "3-18",
