...
export const chapter3Part2Data: StudyCardData[] = [
  ...
  },
  {
    ...
    explanation: {
      ...
      reasonMY: "Limit Tolerance (限界許容差) သည် လုံးဝ(လုံးဝ) ကျော်လွန်ခွင့်မရှိသော အတိအကျသတ်မှတ်ချက်ဖြစ်သည်။ ၎င်းကို ကျော်လွန်ပါက အလိုအလျောက် Defect (အပယ်ခံ) ဖြစ်သွားမည်ဖြစ်သည်။ ထို့ကြောင့် ခြွင်းချက်အနေဖြင့် ခွင့်ပြုနိုင်သေးသည့်သဘော သက်ရောက်သော '原則として許されない (မူအရ ခွင့်မပြုပါ)' ဟူသော အသုံးအနှုန်းဖြင့် ဖော်ပြခြင်းမှာ မှားယွင်းပါသည်။ ပြတ်ပြတ်သားသား '許されない (ခွင့်မပြုပါ)' ဟုသာ သတ်မှတ်ရမည်ဖြစ်သည်။",
      memoryTipMY: "限界許容差 (Limit Tolerance) တွင် '原則として (မူအရ)' ဟူသော ခြွင်းချက်မရှိပါ။ လုံးဝ ကျော်ခွင့်မရှိပါ။"
    }
  },
  {
    id: "3-18",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 5, textJP: "(5) <ruby>付属金物類<rt>ふぞくかなものるい</rt></ruby>の<ruby>組立て溶接<rt>くみたてようせつ</rt></ruby>は、<ruby>入熱量<rt>にゅうねつりょう</rt></ruby>が <ruby>過大<rt>かだい</rt></ruby>になりがちなので<ruby>注意<rt>ちゅうい</rt></ruby>する。", textMY: "ဆက်စပ်ပစ္စည်းများ ယာယီဂဟေဆက်ရာတွင် အပူလွန်ကဲ (High heat input) တတ်သဖြင့် သတိပြုရမည်။" }
    ],
    correctOptionId: 5,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>書類検査 2<rt>しょるいけんさに</rt></ruby>は、<ruby>社内検査記録<rt>しゃないけんさきろく</rt></ruby>が <ruby>部分的<rt>ぶぶんてき</rt></ruby>にしかない<ruby>場合<rt>ばあい</rt></ruby>にも<ruby>適用<rt>てきよう</rt></ruby>できる。", textMY: "Document Inspection 2 သည် မှတ်တမ်းအချို့သာရှိလျှင်လည်း သုံးနိုင်သည်။" },
  ...
  },
  {
    ...
    questionMY: "JASS 6 အရ အတိုင်းအတာ တိကျမှု၏ လက်ခံစစ်ဆေးခြင်းဆိုင်ရာ အသင့်လျော်ဆုံးမဟုတ်သည့်အချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>書類検査 1<rt>しょるいけんさいち</rt></ruby>は、<ruby>社内検査記録<rt>しゃないけんさきろく</rt></ruby>が <ruby>全数<rt>ぜんすう</rt></ruby>ある<ruby>場合<rt>ばあい</rt></ruby>にのみ<ruby>適用<rt>てきよう</rt></ruby>できる<ruby>方法<rt>ほうほう</rt></ruby>である。", textMY: "Document Inspection 1 သည် စက်ရုံတွင်းမှတ်တမ်း ၁၀၀% ရှိမှသာ သုံးနိုင်သည်။" },
      ...
      { id: 3, textJP: "(3) <ruby>書類検査 2<rt>しょるいけんさに</rt></ruby>は、<ruby>社内検査記録<rt>しゃないけんさきろく</rt></ruby>が <ruby>部分的<rt>ぶぶんてき</rt></ruby>にしかない<ruby>場合<rt>ばあい</rt></ruby>にも<ruby>適用<rt>てきよう</rt></ruby>できる。", textMY: "Document Inspection 2 သည် မှတ်တမ်းအချို့သာရှိလျှင်လည်း သုံးနိုင်သည်။" },
  ...
  },
  {
    ...
    questionMY: "ချို့ယွင်းချက်ကို ဖြေရှင်းခြင်းနှင့် ထပ်မဖြစ်အောင် ကာကွယ်ခြင်းဆိုင်ရာ အသင့်လျော်ဆုံးမဟုတ်သည့်အချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>不具合<rt>ふぐあい</rt></ruby>の<ruby>状況<rt>じょうきょう</rt></ruby>を <ruby>調査<rt>ちょうさ</rt></ruby>し、<ruby>定性的・定量的<rt>ていせいてき・ていりょうてき</rt></ruby>に<ruby>正<rt>ただ</rt></ruby>しくとらえることが<ruby>重要<rt>じゅうよう</rt></ruby>である。", textMY: "ချို့ယွင်းချက်အခြေအနေကို အရေအတွက်နှင့် အရည်အသွေးအရ မှန်ကန်စွာ သိရှိရန် အရေးကြီးသည်။" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, textJP: "(2) <ruby>完全溶込溶接部<rt>かんぜんようこみようせつぶ</rt></ruby>の<ruby>機械的性質<rt>きかいてきせいしつ</rt></ruby>は、<ruby>母材<rt>ぼざい</rt></ruby>の JIS <ruby>規格値以上<rt>きかくちいじょう</rt></ruby>が <ruby>要求<rt>ようきゅう</rt></ruby>される。", textMY: "Full Penetration Weld ၏ ခိုင်မာမှုမှာ base metal ၏ စံနှုန်းအတိုင်း ရှိရန် လိုအပ်သည်။" },
      { id: 3, textJP: "(3) <ruby>柱・梁接合部<rt>ちゅう・はりせつごうぶ</rt></ruby>には、<ruby>強度<rt>きょうど</rt></ruby>および<ruby>靭性<rt>じんせい</rt></ruby>が <ruby>要求<rt>ようきゅう</rt></ruby>される。", textMY: "တိုင်နှင့် မြားတန်းဆုံမှတ်တွင် ခိုင်မာမှု (Strength) နှင့် ကြံ့ခိုင်မှု (Toughness) တို့ လိုအပ်သည်။" },
  ...
  },
  {
    ...
    questionMY: "ဂဟေဆက်နေရာ၏ အရည်အသွေးစီမံမှုဆိုင်ရာ အသင့်လျော်ဆုံးမဟုတ်သည့်အချက်ကို ရွေးချယ်ပါ။",
    options: [
      { id: 1, textJP: "(1) <ruby>品質<rt>ひんしつ</rt></ruby>に<ruby>影響<rt>えいきょう</rt></ruby>を<ruby>及ぼす要因<rt>およぼすよういん</rt></ruby>を <ruby>適切<rt>てきせつ</rt></ruby>に<ruby>組み合わせる<rt>くみあわせる</rt></ruby>ことで品質を<ruby>確保<rt>かくほ</rt></ruby>する。", textMY: "အချက်များကို မှန်ကန်စွာ ပေါင်းစပ်ခြင်းဖြင့် အရည်အသွေးကို အာမခံရမည်။" },
      ...
      { id: 3, textJP: "(3) <ruby>隅肉溶接<rt>すみにくようせつ</rt></ruby>は <ruby>溶接金属<rt>ようせつきんぞく</rt></ruby>の<ruby>強度<rt>きょうど</rt></ruby>が <ruby>母材規格値<rt>ぼざいきかくち</rt></ruby>の 90% <ruby>以上<rt>いじょう</rt></ruby>とする。", textMY: "Fillet weld ၏ ခိုင်မာမှုသည် base metal စံနှုန်း၏ ၉၀% နှင့်အထက် ရှိရမည်။" },
      { id: 4, textJP: "(4) <ruby>完全溶込溶接<rt>かんぜんようこみようせつ</rt></ruby>の <ruby>欠陥率<rt>けっかんりつ</rt></ruby>は AOQL で<ruby>決められている<rt>きめられている</rt></ruby>。", textMY: "Full penetration weld ၏ ချို့ယွင်းချက်နှုန်းကို AOQL ဖြင့် သတ်မှတ်သည်။" },
